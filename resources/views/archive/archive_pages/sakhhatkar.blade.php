    ...
    <div class="form-group">
        ...
        <div class="col-md-2">
            ...
            <select class="form-control" name="item_type">
                ...
                ?>
                @foreach($sakhhatkar_item_info as $key => $name)
        ...
        <div class="col-md-4">
            ...
            <a href="{{ url('archive_book?archive_type=6') }}">
...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        ?>
        <span class="badge">
                                                {{ get_sakhhatkar_key_text($key_id)  }}
            <?php
            foreach(array_unique($_REQUEST[get_sakhhatkar_key_name($key_id)]) as $index  =>  $value) {
            echo $value;
            ?>
                                                <a href="{{ get_request_url(get_sakhhatkar_key_name($key_id),$index)  }}">
                                                    <i style="color:darkred" class="fa fa-close"></i>
                                                </a>
                                                <?php
            }
