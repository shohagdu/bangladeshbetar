...
'class'=>'form-horizontal']) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            ...
            <a href="{{ url('archive_book?archive_type=5') }}">
...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        ?>
        <span class="badge">
                                                {{ get_vhason_key_text($key_id)  }}
            <?php
            foreach(array_unique($_REQUEST[get_vhason_key_name($key_id)]) as $index  =>  $value) {
            echo $value;
            ?>
                                                <a href="{{ get_request_url(get_vhason_key_name($key_id),$index)  }}">
                                                    <i style="color:darkred" class="fa fa-close"></i>
                                                </a>
                                                <?php
            }
...
<div class="col-sm-12">
    <table id="dt_archive__" class="table table-striped table-bordered table-hover"
        ...
        <td>{{$item_info->vhason_kari}}</td>
        <td>{{$item_info->designation}}</td>
        <td>{{$item_info->prodaner_tarikh}}</td>
