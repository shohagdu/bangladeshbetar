                ...
                <div class="widget-body no-padding">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" required placeholder="প্লে লিস্টের নাম" class="form-control"
                                       name="name" value="{{$playlist->name}}"  id="name"/>
                            </div>
                            ...
                            <div class="col-md-4">
                                <input type="text" readonly name="playlist_id"
                                       value="{{$playlist->playlist_id}}" placeholder="প্লে লিস্ট আইডি"
                                       class="form-control"/>
                            </div>
                        ...
                        <div class="form-group">
                                ...
                                <select id="station_id" required class="form-control"
                                    ...
                                    @if(!empty($station_info))
                                        @foreach($station_info as $key=>$value)
                                            <option {{ $key == $playlist->station_id ? 'selected' : false }} value="{{ $key }}">{{ $value }}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
                            ...
                            <div class="col-md-4">
                                <select id="sub_station_id" required class="form-control" name="sub_station_id">
                                    <option value="">চিহ্নিত করুন</option>
                                    @if(!empty($sub_station_info))
                                        @foreach($sub_station_info as $key=>$value)
                                            <option {{ $value->id == $playlist->sub_station_id ? 'selected' : ''}}  value="{{ $value->id }}">{{ $value->title.'('.$value->fequencey.')' }}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="program_name" value="{{$playlist->program_name}}" placeholder="অনুষ্ঠানের নাম" class="form-control"/>
                            </div>
                            <label class="col-md-2 control-label">অনুষ্ঠানের বিষয়</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" value="{{$playlist->program_subject}}" placeholder="অনুষ্ঠানের বিষয়" name="program_subject"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="boardcast_date" value="{{$playlist->boardcast_date}}" placeholder="সম্প্রচার তারিখ" class="form-control datepickerLong"/>
                            </div>
                            <label class="col-md-2 control-label">সম্প্রচার সময়</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control  timepicker" value="{{$playlist->boardcast_time}}" placeholder="সম্প্রচার সময়" name="boardcast_time"/>
                            </div>
                        </div>
                        ...
                        <a style="float:left;" href="{{url('donwloadMultipleFile/'.$playlist->id)}}">
                                ...
                                ?>
                                    <td>
                                        ...
                                        <a href="javascript:void(0)" title="Play"
                                           ...
                                           onClick="audioAction('{{url( get_file_path((int)$row['song_id']) )}}',<?php  echo (int) $row['song_id']; ?>);">
                                            <i class="fa fa-play"></i>
                                        </a>
                                        <a href="{{ url('archive_item_view/'.$row['song_id']) }}">
                                            <button type="button" title="view" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></button>
                                        </a>
                                        <a href="{{ url('archive_item_download/'.$row['song_id']) }}" title="Download" class="btn btn-success btn-sm">
