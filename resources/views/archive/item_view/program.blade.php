                    ...
                    <div class="col-sm-12" >
                        ...
                        <table style="width:100%;border:1px solid #d0d0d0" rules="all"  class="table table-bordered"
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ !empty($item_info->program_vhittik)?program_vittik_name($item_info->program_vhittik) : 'N/A'  }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ !empty($item_info->gobeshona)  ? get_shilpi_name_by_ids($item_info->gobeshona) : ''  }}
                                </td>
                                <td class="text-bold">
                                    গ্রন্থনা
                                </td>
                                <td colspan="3">
                                    {{ !empty($item_info->gronthona)  ? get_shilpi_name_by_ids($item_info->gronthona) : ''  }}
                                </td>
                                <td class="text-bold">উপস্থাপনা</td>
                                <td>
                                    {{ !empty($item_info->uposthapona)  ? get_shilpi_name_by_ids($item_info->uposthapona) : ''  }}
                                </td>
                            </tr>
