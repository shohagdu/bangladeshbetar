                    ...
                    <div class="col-sm-12" >
                        ...
                        <table style="width:100%;border:1px solid #d0d0d0" rules="all"  class="table table-bordered"
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ !empty($song_info->artist)  ? get_shilpi_name_by_ids($song_info->artist) : ''}}
                                </td>
                                <td>
                                    {{ !empty($song_info->gitikar)  ? get_shilpi_name_by_ids($song_info->gitikar) : ''}}
                                </td>

                                <td>
                                    {{ !empty($song_info->surokar)  ? get_shilpi_name_by_ids($song_info->surokar) : ''}}
                                </td>

{{--                                <td>--}}
{{--                                    {{ !empty($film_info->film_name)  ? $film_info->film_name : ''}}--}}
{{--                                </td>--}}

{{--                                <td>--}}
{{--                                    {{!empty($song_info->band_id) ? get_name_by_id('archive_band', ['id' => $song_info->band_id])->name : ''}}--}}
{{--                                </td>--}}

                                <td>
                                    {{ !empty($song_info->stability)  ? $song_info->stability : ''}}
                                </td>
                                <td>
