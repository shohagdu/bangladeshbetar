                    ...
                    <div class="col-sm-12">
                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                            ...
                            @foreach($items as $singleData)
                                <tr>
                                    <td>  {{ $i++  }}</td>
                                    <td>  {{ $singleData->song_category  }}</td>
                                    ...
                                    <td>
                                        <button type="button"data-toggle="modal" data-target="#exampleModal" onclick="UpdateSetupInfo('{{ $singleData->id }}','{{ $singleData->name }}','{{ $singleData->is_active }}','{{ $singleData->parent_id }}')" class="btn btn-primary btn-xs">
                                            <i class="glyphicon glyphicon-pencil"></i>
                                        </button>
                                        <button type="button" onclick=" ArchiveCategoryDelete('{{ $singleData->id }}')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> </button>
                                    </td>
                ...
                <div class="modal-body">
                    <div class="col-sm-12" style="margin-top:10px;">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">{{ $main_title }}</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" required  id="title" class="form-control" placeholder="{{ $page_title }}"  value="" name="name"/>
                            </div>
                        </div>
                        <div class="form-group">
