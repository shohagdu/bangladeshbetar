...
@section('title_area')
    :: State Management :: Immovable Property Information   ::
    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <h2>Immovable Property Information </h2>
                ...
                <div class="modal-body">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="land_tax_pay_dt" class="form-control datepickerinfo" placeholder="Last of Pay Tax (কর) No" value="{{ date('d-m-Y') }}"  name="land_tax_pay_dt"/>
                            </div>
