                                ...
                                <td colspan="4" class="no-border">
                                    <table class="width100per">
                                        <tr>
                                            ...
                                            <td class="width10per vertical-align-top no-border">
                                                <img src="{{ ((file_exists('images/employee_image/'.$employee_info->image) && !empty($employee_info->image) )?url('images/employee_image/'.$employee_info->image):url('images/default/default-avatar.png'))  }} "
                                                     alt="Bangladesh Betar"
                            ...
                            <tr>
                                ...
                                <td>:
                                    @if(!empty($parmanent_address))
                                        <b>Vill/House/Road</b>:{{ $parmanent_address->vill_road }}, <b>Post Office</b>: {{ $parmanent_address->post_office }}, <b>Police  Station</b>: {{ $parmanent_upazila_info->name }}, <b>District</b>:{{ $parmanent_district_info->name }}
                                    @endif
                                </td>
                            </tr>
