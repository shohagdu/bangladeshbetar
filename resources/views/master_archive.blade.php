...
@include('template.include.left_bar_archive')
<!-- END NAVIGATION -->
...
<script data-pace-options='{ "restartOnRequestAfter": true }' src="{{ asset('fontView') }}/assets/js/plugin/pace/pace.min.js"></script>
