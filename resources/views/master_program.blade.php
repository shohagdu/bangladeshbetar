...
@include('template.include.left_bar_program')
<!-- END NAVIGATION -->
...
<div class="page-footer">
    <div class="row">
        <div class="col-xs-12 col-sm-6 no-print">
            <span class="txt-color-white">  All right reserved at 2019-<?php echo date('Y') ?>.  Design & Developed By <span class="hidden-xs">  <a href="http://www.betar.gov.bd/"
...
<script src="{{ asset('fontView') }}/assets/modules/js/employee_info.js"></script>
<script src="{{ asset('fontView') }}/assets/modules/js/setup_info.js"></script>
<script src="{{ asset('fontView') }}/assets/modules/js/leave_info.js"></script>
<script src="{{ asset('fontView') }}/assets/modules/js/programInfo.js"></script>
<script src="{{ asset('fontView') }}/assets/modules/js/asset_info.js"></script>
<script src="{{ asset('fontView') }}/assets/modules/js/employee_payrole.js"></script>
<script src="{{ asset('fontView') }}/assets/modules/js/archive.js"></script>
