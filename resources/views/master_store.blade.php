...
<div class="no-print">
    ...
    @include('template.include.left_bar_store')
    <!-- END NAVIGATION -->
</div>
<!-- MAIN PANEL -->
...
<div id="main" role="main">
    ...
    <div class="no-print">
        <div id="ribbon">
            ...
            <!-- breadcrumb -->
            <ol class="breadcrumb">
                <li><a href="<?php  echo asset('/store');?>">Store Management</a></li>
...
<script src="{{ asset('fontView') }}/assets/modules/js/store_mng.js"></script>
