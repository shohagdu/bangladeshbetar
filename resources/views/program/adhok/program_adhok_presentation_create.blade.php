                            ...
                            @if(!empty($presentation_info))
                                @foreach($presentation_info as $singleData)
                                    ...
                                    && $singleData->is_re_planning==1)?("background: lightgray"):'')
                                        ...
                                        <td>
                                            <a href="{{ url('presentation_info_report/'.$singleData->months.'/'
                                            .$singleData->station_id.'/2') }}"
                                               class="btn btn-info btn-xs"><i class="glyphicon
                                               glyphicon-share-alt"></i> View
                                            </a>
                                            <a href="{{ url('presentation_info_report_date/'.$singleData->months.'/'
                                            .$singleData->station_id.'/2') }}"
                                               class="btn btn-info btn-xs"><i class="glyphicon
                                            ...
                                            <button onclick="deletePresentationInfo('{{ $singleData->months }}',
                                                    '{{$singleData->station_id}}',2)"
