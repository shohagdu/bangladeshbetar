    ...
    <tr>
        ...
        <td>
            <table class="table-bordered table">
                ...
                <tr>
                    <td>{{  (!empty($odivison))?$odivision_data[$odivison]:'' }}</td>
                    <?php
        ...
        <td style="width:100px;">
            <button type="button" onclick="adhokt_add('{{ $date }}',$('#station_id').val(),$('#sub_station_id').val(),$('#presentation_id').val())" class="btn
            btn-primary
            btn-sm">এডহক
                সংযুক্তি</button>
        </td>
