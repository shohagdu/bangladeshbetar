            ...
            <div>
                <div class="widget-body no-padding">
                    <div class="col-sm-12" style="margin-top:20px;">
                        ...
                        {!! Form::open(['url' => '', 'method' => 'post','id' => 'save_artist_info_form',
                                ...
                                <select id="present_district" tabindex="14" class="form-control"
                                    ...
                                    @if(!empty($all_district))
                                        @foreach($all_district as $key=>$value)
                                            <option value="{{ $key }}" {{ (isset($present_address['district']) && $present_address['district']==$key)?"selected":''  }} >
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    @endif
        ...
        $('#artist_expertise_info_all').on('click', function () {
            ...
            $(`<tr><td><select  name="expertise[]" id="expertise_${c}" class="form-control  artist_expertise"><option
             value=""> চিহ্নিত করুন</option>
                                            ...
                                            id="expertise_grade_'+b+'"><option value="">চিহ্নিত করুন</option> @if(!empty($artist_grade_info))
                                                    @foreach ($artist_grade_info as $key =>$value)  <option   value="{{ $key }}">{{ $value }}</option>                                             @endforeach
            @endif                                         </select>
             ...
             artist_hounoriam_ctg"><option value=""> চিহ্নিত করুন</option> @if(!empty($program_ctg))
                                    ...
                                    @endif</select></td><td ><select style="width:200px;"  placeholder="চিহ্নিত করুন"
