            ...
            <div>
                <div class="widget-body no-padding">
                    <div class="col-sm-12" style="margin-top:20px;">
                        ...
                        {!! Form::open(['url' => '', 'method' => 'post','id' => 'artist_info_update_form',
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <select id="status" class="form-control" required name="status">
                                    ...
                                    <option value="1" {{ (!empty($artist_info_show->is_active) &&
                                        $artist_info_show->is_active==1) ?
                           "selected":'' }} >Active</option>
                                    <option value="2"  {{ (!empty($artist_info_show->is_active) &&
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select id="artist_doptor" class="form-control"
                                    ...
                                    <option value="">চিহ্নিত করুন</option>
                                    <option value="1" {{ (!empty($artist_info_show->artist_doptor) &&
                                            $artist_info_show->artist_doptor==1) ?
                               "selected":'' }} >অনুষ্ঠান বিভাগ</option>
                                    <option value="2" {{ (!empty($artist_info_show->artist_doptor) &&
                            ...
                            <div class="col-md-4">
                                <select required name="artist_ctg" id="artist_ctg" class="form-control">
                                    ...
                                    @if(!empty($artist_type))
                                        @foreach ($artist_type as $key => $value)
                                            <option {{ (!empty($artist_info_show->artist_type) &&
                                ...
                                <select id="station_id" class="form-control" name="station_id">
                                    ...
                                    @if(!empty($station_info))
                                        @foreach($station_info as $key=>$value)
                                            <option {{ $artist_info_show->station_id == $key ? 'selected': '' }} value="{{ $key }}">{{ $value }}</option>
                                        @endforeach
                                    @endif
                                </select>

                            </div>
                            <div id="staff_artist"  style="display: {{(!empty($artist_info_show->artist_type) &&
                                            $artist_info_show->artist_type==2) ?'block':'none' }};">
                                <label class="col-md-2 control-label">স্টাফ আই ডি</label>
                                <div class="col-md-4">

                                    <input type="text" value="{{ (!empty($artist_info_show->staff_id))?
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text"  value="{{ (empty($artist_info_show->enlisted_last_date) ||
                            ...
                            <div class="col-md-4">
                                <input type="text"  value="{{ (empty($artist_info_show->enlisted_date) ||
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="artist_name_bn"  value="{{ !empty($artist_info_show->name_bn)?
                            ...
                            <div class="col-md-4">
                                <input type="text" id="artist_short_name"  value="{{ $artist_info_show->artist_short_name }}" class="form-control" required
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="artist_name" value="{{ !empty($artist_info_show->name)?
                            ...
                            <div class="col-md-4">
                                <select id="national_awarded" class="form-control" name="national_awarded">
                                    <option value="">চিহ্নিত করুন</option>
                                    @if(!empty($national_award_info))
                                        @foreach($national_award_info as $key=>$value)
                                            <option   {{ !empty($artist_info_show->national_awarded) &&
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="father_name" value="{{ !empty($artist_info_show->father_name)?
                            ...
                            <div class="col-md-4">
                                <textarea id="artist_occupation" placeholder="পেশা" class="form-control"
                                          name="artist_occupation">{{ !empty( $artist_info_show->artist_occupation)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="mother_name"  value="{{ !empty( $artist_info_show->
                                ...
                                <select id="nationality" class="form-control" name="nationality">
                                    ...
                                    @if(!empty($nationality))
                                        @foreach($nationality as $key=>$value)
                                            <option {{ !empty($artist_info_show->nationality) &&
                            ...
                            <div class="col-md-4">
                                <div style="width: 35%;float: left;">
                                    <select id="husband_wife_type" class="form-control" name="husband_wife_type">
                                        <option value="" >চিহ্নিত করুন</option>
                                        <option value="1" {{ !empty($artist_info_show->is_husband_wife) &&
                                            ($artist_info_show->is_husband_wife == 1) ?
                                            'selected': '' }}>স্বামী</option>
                                        <option value="2" {{ !empty($artist_info_show->is_husband_wife) &&
                                ...
                                <div style="width: 65%;float: left;">
                                    <div class="col-sm-12">
                                        <input type="text" id="husband_wife" class="form-control"
                                               name="husband_wife" value="{{ !empty($artist_info_show->husband_wife_name)?
                                ...
                                <select id="present_district" class="form-control" name="present_district">
                                    ...
                                    @if(!empty($all_district))
                                        @foreach($all_district as $key=>$value)
                                            <option value="{{ $key }}" {{ (isset($artist_info_show->artist_district) && $artist_info_show->artist_district==$key)?"selected":''  }} >
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select id="merital_status" class="form-control" name="merital_status">
                                    <option value="">চিহ্নিত করুন</option>
                                    <option value="1" {{ !empty($artist_info_show->marital_status) &&
                                            ($artist_info_show->marital_status == 1) ?
                                            'selected': '' }}>বিবাহিত</option>
                                    <option value="2" {{ !empty($artist_info_show->marital_status) &&
                            ...
                            <div class="col-md-4">
                                <select id="gender" class="form-control" name="gender">
                                    <option value="">চিহ্নিত করুন</option>
                                    <option value="1"  {{ !empty($artist_info_show->gender) &&
                                            ($artist_info_show->gender == 1) ?
                                            'selected': '' }}>পুরয়ষ</option>
                                    <option value="2"  {{ !empty($artist_info_show->gender) &&
                                            ($artist_info_show->gender == 2) ?
                                            'selected': '' }}>মহিলা</option>
                                    <option value="3"  {{ !empty($artist_info_show->gender) &&
                        ...
                        <textarea id="address_info" class="form-control" placeholder="ঠিকানাা"
                                  name="address_info">{{ !empty($artist_info_show->address)?$artist_info_show->address:'' }}</textarea>
                            </div>
                        ...
                        <textarea id="education_info" class="form-control" placeholder="শিক্ষাগত যোগ্গতা"
                                  name="educational_info">{{ !empty($artist_info_show->educational_info)?$artist_info_show->educational_info:'' }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <div id="mobile_no_log_info_{{ $indexed }}">
                                    <div class="col-sm-8">
                                        <div class="row">
                                            <input type="text" id="mobile_no_{{ $key }}" value="{{ $mobile }}"
                                                   class="form-control"
                                                   placeholder="মোবাইল"
                                                   name="mobile_no[]"/>
                                        </div>
                                    ...
                                    <div class="col-sm-4" style="margin-top:5px;">
                                        <a href="javascript:void(0);"  id="deleteRow_{{ $indexed }}"  class="delete-row btn
                            ...
                            <div class="col-md-4">
                                <input type="text" id="email_address" value="{{ !empty($artist_info_show->email)?
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="file" id="picture" class="form-control"
                                       name="picture"/>
                                <input type="hidden" name="old_image" id="old_image" value="{{  !empty
                            ...
                            <div class="col-md-4">
                                <input type="file" id="signature" class="form-control"
                                       name="signature"/>
                                <input type="hidden" name="old_signature" id="old_signature" value="{{  !empty
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="fb_id_link" value="{{ !empty($artist_info_show->fb_id_link)?
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="birth_certificate_id" value="{{ !empty($artist_info_show->birth_certificate_id)?
                            ...
                            <div class="col-md-4">
                                <input type="text" id="old_artist_no" value="{{ !empty($artist_info_show->artist_old_id)?
                        ...
                        <div class="form-group">
                                ...
                                <select name="bank_name" class="form-control" id="bank_name">
                                    ...
                                    @if(!empty($bank_info))
                                        @foreach($bank_info as $key=>$value)
                                            <option {{ (!empty($artist_info_show->bank_name) &&
                            ...
                            <div class="col-md-4">
                                <input type="text" value="{{ !empty($artist_info_show->bank_branch_name)?
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" value="{{ !empty($artist_info_show->bank_account_no)?
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text"  value="{{ !empty($artist_info_show->fixed_amount)?
                                $artist_info_show->fixed_amount:'' }}"  name="fixed_amount" placeholder="এক কালিন টাকা পরিমান"
                                       class="form-control" id="fixed_amount">
                            </div>
                            <div class="col-md-3">
                                <input type="text" name="per_day_amount" value="{{ !empty($artist_info_show->per_day_amount)?
                                $artist_info_show->per_day_amount:'' }}"  placeholder="দৈনিক টাকা"
                                       class="form-control" id="per_day_amount">
                            </div>
                            <div class="col-md-3">
                                <input type="text" name="total_days" value="{{ !empty($artist_info_show->total_days)?
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>
                                            <select required name="expertise[]" id="expertise_{{ $key_main }}"
                                                    class="form-control artist_expertise"><option value=""> চিহ্নিত
                                                    করুন</option> @if(!empty($expertise_dept))
                                                    @foreach ($expertise_dept as $key => $value)  <option {{ (!empty
                                                    ( $expertise['expertise']) &&  $expertise['expertise']==$key) ?
                               "selected":'' }} value="{{ $key }}">{{ $value }}</option>@endforeach
                                                @endif</select></td>
                                        <td>
                                            <select id="expertise_dept_{{ $key_main }}"class="form-control" name="expertise_dept[]"> <option value="">চিহ্নিত করুন</option>
                                                @foreach ($expertise['all_expertise_dept_By_expertise'] as $key =>
                                                $value)  <option {{ (!empty
                                                    ( $expertise['expertise_dept']) &&  $expertise['expertise_dept']==$key) ?"selected":'' }}  value="{{ $key }}">{{ $value }}</option>
                                                @endforeach
                                            </select>
                                        </td>
                                        <td><select 
                                                    ...
                                                    class="form-control"
                                                    id="expertise_grade_{{ $key_main }}"><option
                                                        value="">চিহ্নিত করুন</option>
                                                @if(!empty($artist_grade_info))
                                                    @foreach ($artist_grade_info as $key =>
                                                    $value)  <option {{ (!empty
                                   ...
                                   "selected":'' }}  value="{{ $key }}">{{ $value }}</option>
                                        ...
                                        <td><a href="javascript:void(0);"  id="deleteRow_{{ $key_main }}"  class="deleteRow btn btn-warning btn-flat btn-sm"><i class="glyphicon glyphicon-remove"></i>  Drop</a></td></tr>
                            ...
                            <div class="col-sm-12">
                                <table class="table table-bordered">
                                    ...
                                    <tr><td><select required name="artist_hounoriam_ctg[]"
                                                    id="artist_hounoriam_ctg_{{ $key_main }}" class="form-control ' +
                'artist_hounoriam_ctg"><option value=""> চিহ্নিত করুন</option>
                                                @if(!empty($program_ctg))
                                                    @foreach ($program_ctg as $key => $value)
                                                        <option value="{{ $key }}" {{ (!empty
                                                    ( $rate_chart['artist_hounoriam_ctg']) &&  $rate_chart['artist_hounoriam_ctg']==$key) ?"selected":'' }}>{{ $value }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </td>
                                        <td>
                                            <select id="chart_description_{{ $key_main }}'" class="form-control
                                        chart_description" name="chart_description[]">
                                                <option value="">চিহ্নিত  করুন</option>
                                                @foreach ($rate_chart['chart_description_data'] as $key =>
                                                $value)  <option {{ (!empty
                                                    ( $rate_chart['chart_description']) &&  $rate_chart['chart_description']==$key) ?"selected":'' }}  value="{{ $key }}">{{ $value }}</option>
                                                @endforeach
                                        ...
                                        <td><select required
                                                    ...
                                                    id="artist_grade_{{
                                                        ...
                                                        value="">চিহ্নিত করুন</option>
                                                @foreach ($rate_chart['chart_description_grade_data'] as $key =>
                                                $value)  <option {{ (!empty
                                                    ( $rate_chart['artist_grade']) &&  $rate_chart['artist_grade']==$key) ?"selected":'' }}  value="{{ $key }}">{{ $value }}</option>
                                                @endforeach
                                            </select>
                                        </td>
                                        <td><a
                                                    href="javascript:void(0);"  id="deleteRow_{{ $key_main }}"
                        ...
                        <div class="modal-footer">
                            ...
                            <div class=" col-sm-5">
                                ...
                                <input type="hidden" name="setting_id" id="setting_id" value="{{ $artist_info_show->id
                                }}">
                            </div>
    ...
    <script>
        ...
        $('#add_artist_song_ctg').on('click', function () {
            $('<tr><td><select required name="artist_hounoriam_ctg[]" id="artist_hounoriam_ctg_'+ a +'" class="form-control ' +
                'artist_hounoriam_ctg"><option value=""> চিহ্নিত করুন</option> @if(!empty($program_ctg))\n' +
                '                                                    @foreach ($program_ctg as $key => $value)\n' +
                '                                                        <option value="{{ $key }}">{{ $value }}</option>\n' +
                '                                                    @endforeach\n' +
                '                                                @endif</select></td><td><select id="chart_description_'+a +'" class="form-control chart_description" name="chart_description[]">\n' +
                '            <option value="">চিহ্নিত করুন</option>\n' +
        ...
        $('#artist_expertise_info').on('click', function () {
            $('<tr><td><select required name="expertise[]" id="expertise_'+ b +'" class="form-control ' +
                'artist_expertise"><option value=""> চিহ্নিত করুন</option> @if(!empty($expertise_dept))\n' +
                '                                                    @foreach ($expertise_dept as $key => $value)\n' +
                '                                                        <option value="{{ $key }}">{{ $value }}</option>\n' +
                '                                                    @endforeach\n' +
                '                                                @endif</select></td><td><select id="expertise_dept_'+ b +'"class="form-control" name="expertise_dept[]">\n' +
                '            <option value="">চিহ্নিত করুন</option>\n' +
                '        </select></td><td><select \n' +
                '                                                    name="expertise_grade[]"\n' +
                '                                                    class="form-control"\n' +
