...
<table class="table-bordered table">
    ...
    <tr>
        ...
        <td>{{ !empty($all_info->program_identity)?$all_info->program_identity:'' }}</td>
        <td>{{ !empty($all_info->program_name)?$all_info->program_name:'' }}</td>
        ...
        <td>
            <textarea name="performance_comments[]" placeholder="মন্তব্য" rows="1" class="form-control"
                      id="performance_comments_{{ $all_info->id
            }}">{{ (!empty($all_info->performance_comments) )?$all_info->performance_comments:"" }}</textarea>
        </td>
