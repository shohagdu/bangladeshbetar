                        ...
                        <tr>
                            <td style="width:100%;border: 1px solid #fff !important;">
                                <table class="table table-bordered print-style-table" style="width: 100%">
                                    ...
                                    <thead>
                                    <tr >
                                        <td style="font-size:14px;font-weight: bold;width:150px;background-color:#d0d0d0;" colspan="{{ (!empty($role_key) &&
                                            $role_key=='duty_officer')
                                            ?1:5 }}" >
                                            {{ !empty($role_key)? $role_info_data[$role_key]:'' }}
                                        </td>
                                        <?php
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                        @if($presentation_heading_info->is_active>=3)
                                            <td style="width: 90px" class="no-print">
                                                <a href="{{ url('payment/pdf/presentation_contact_paper.php?station='
