                    ...
                    <table class="print_table-no-border "  style="width:100%;border: 1px solid #fff !important;">
                        <tr>
                            <td    style="text-align: center;width:40%;border: 1px solid #fff!important" >
                                ...
                                <div style="font-size:14px;">{{ $presentation_info[0]->name }}</div>
                                <div style="font-size:14px;">{{ $presentation_info[0]->address }}</div>
                                <div style="font-size:14px;">{{ $presentation_info[0]->fequencey_data }}</div>
                                <b><u> অধিবেশন কক্ষে প্রচার সংশ্লিষ্টদের তালিকা </u></b>
                                <div class="clearfix"></div>
                                <span><b> মাস: </b> {{ (!empty($presentation_info[0]->months))?
                                $month_info[$presentation_info[0]->months]:'' }} </span>
                                <span style="padding-left:10px;"><b>সাল:</b> {{
                              (!empty($presentation_info[0]->presentation_year))?
...
//                                        exit;
                                    ...
                                    <tr>
                                        <td>{{ (!empty($info->presentation_date))?eng2bnNumber
