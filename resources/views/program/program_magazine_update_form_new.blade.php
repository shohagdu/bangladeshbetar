            ...
            <div class="modal fade" id="myModal" role="dialog">
                ...
                'class'=>'form-horizontal']) !!}
                        <div class="modal-body">
                            <div class="col-sm-12" style="margin-top:10px;">
                                        ...
                                        <select id="station_id" onchange="getSubStation(this.value)" class="form-control" name="station_id">
                                            ...
                                            @if(!empty($station_info))
                                                @foreach($station_info as $key=>$value)
                                                    <option {{$key===$get_program_planning_info->station_id?'selected':''}} value="{{ $key }}">{{ $value }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" id="program_name" value="{{$get_program_planning_info->program_name}}" class="form-control" required name="program_name"
                                        ...
                                        <select id="program_type" class="form-control" name="program_type">
                                            ...
                                            @if(!empty($program_type))
                                                @foreach($program_type as $key=>$value)
                                                    <option {{$key===$get_program_planning_info->program_type?'selected':''}} value="{{ $key }}">{{ $value }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input type="checkbox" {{$get_program_planning_info->fixed_program_type_id >0 ? 'checked':''}} onclick="is_program_type_check(this)" id="is_fixed_program"
                                               name="is_fixed_program"/> উৎসব ও বার্ষিকী অনুষ্ঠান
                                    </div>
                                    <div style="display:{{$get_program_planning_info->fixed_program_type_id >0 ? 'block':'none'}}" id="fixed_program_type_div">
                                        ...
                                        <div class="col-md-3">
                                            <select id="fixed_program_type" class="form-control" name="fixed_program_type">
                                                ...
                                                @foreach($get_fixed_program_type as $value)
                                                    <option {{$value->id===$get_program_planning_info->fixed_program_type_id?'selected':''}} value="{{$value->id}}">{{$value->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-3">
                                            <select id="sub_fixed_program_type" class="form-control" name="sub_fixed_program_type">
                                                ...
                                                <?php foreach($fix_sub_program_type as $value) { ?>
                                                    <option {{$value->id===$get_program_planning_info->sub_fixed_program_type_id?'selected':''}} value="<?php echo $value->id ?>"><?php echo $value->name ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">রেকর্ডিং তারিখ <span
                                                ...
                                                class="mandatory_field">*</span></label>
                                    <div class="col-md-2">
                                        <input type="text" value="{{$get_program_planning_info->recorded_date}}" class="form-control datepickerLong" placeholder="রেকডিং তারিখ"
                                               name="recorded_date"/>
                                    </div>
                                    <div class="col-md-2">
                                        <input type="checkbox" {{$get_program_planning_info->recording_date_is_plexibity >0? 'checked':''}} onclick="" id="recording_date_is_plexibity"
                                    ...
                                    <label class="col-md-2 control-label">রেকর্ডিং সময় <span
                                                ...
                                                class="mandatory_field">*</span></label>
                                    <div class="col-md-2">
                                        <input type="text" id="recorded_time" value="{{$get_program_planning_info->recorded_time}}" class="form-control timepicker" required
                                               name="recorded_time"
                                               placeholder="রেকডিং সময়">
                                    </div>
                                    <div class="col-md-2">
                                        <input type="checkbox" {{$get_program_planning_info->recording_time_is_plexibity >0 ? 'checked':''}} onclick="" id="recording_time_is_plexibity"
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">প্রচার তারিখ <span
                                                class="mandatory_field">*</span></label>
                                    <div class="col-md-2">
                                        <input type="text" value="{{$get_program_planning_info->live_date}}"  class="form-control datepickerLong" placeholder="প্রচার তারিখ"
                                               name="live_date"/>
                                    </div>
                                    <div class="col-md-2">
                                        <input type="checkbox" {{$get_program_planning_info->live_date_is_plexibity >0 ? 'checked':''}} onclick="" id="live_date_is_plexibity"
                                               name="live_date_is_plexibity"/> প্রয়োজন মত
                                    </div>
                                    <label class="col-md-2 control-label">প্রচার সময় <span
                                                class="mandatory_field">*</span></label>
                                    <div class="col-md-2">
                                        <input type="text" value="{{$get_program_planning_info->live_time}}" id="live_time" class="form-control timepicker" required
                                               name="live_time"
                                               placeholder="প্রচার সময়">

                                    </div>
                                    <div class="col-md-2">
                                        <input type="checkbox" {{$get_program_planning_info->live_time_is_plexibity >0 ? 'checked':''}} onclick="" id="live_time_is_plexibity"
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label"> স্থিতি <span
                                                class="mandatory_field">*</span></label>
                                    <div class="col-md-4">
                                        <input type="text" value="{{$get_program_planning_info->recording_stabilty}}" id="recording_stabilty" class="form-control" placeholder="স্থিতি"
                                    ...
                                    <div class="col-md-4">
                                        <select required name="record_type" class="form-control" id="record_type">
                                            <option value="">চিহ্নিত করুন</option>
                                            <option {{$get_program_planning_info->record_type==1 ? 'checked':''}} value="1">সজীব</option>
                                            <option {{$get_program_planning_info->record_type==2 ?'checked':''}} value="2">রেকর্ড</option>
                                        </select>
                    ...
                    <textarea class="form-control" placeholder="উদ্দেশ্য/বিষয়"
                              name="larget_viewer">{{$get_program_planning_info->larget_viewer}}</textarea>
                                    </div>
                                </div>
                                                    ...
                                                    <select  id="magazine_manage_{{ $key }}" placeholder="শিল্পীর নাম"  class="select2"
                                                        ...
                                                        @if(!empty($employee_info))
                                                            @foreach($employee_info as $ekey=> $value)
                                                                <option {{ isset($program_manager[$key]) &&  is_array($program_manager) && in_array($ekey,$program_manager[$key]) ? 'selected' : '' }} value="{{ $ekey }}">{{ $value }}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </td>
                                                <td colspan="2"><button type="button" id="delete_manage_{{ $key }}"
                                                            class="btn
