                            ...
                            @if(!empty($program_info))
                                @foreach($program_info as $singleData)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" data-toggle="modal" data-target="#exampleModal" title="Update"
        ...
        <div class="modal-dialog" role="document" style="width:70%;">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-sm-6">
                        <h5 class="modal-title" id="exampleModalLabel"><span id="heading-title"></span> Program Schedule Create</h5>
                    </div>
                    <div class="col-sm-6">
