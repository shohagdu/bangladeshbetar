            ...
            <table style="width:100%;border:1px solid #d0d0d0" rules="all" class="table table-bordered " id="print_table">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        {{  !empty($description->number_of_days)?eng2bnNumber($description->number_of_days):'' }}
                    </td>
                    <td>
                        <?php
                    ...
                    <td class="text-right">
                        {{ $description->mohoda_amount }}
                    </td>
                    <td class="text-right">
                        {{ (!empty($description->artist_ta_amount))?number_format
                       ($description->artist_ta_amount,2,'.',''):'0.00' }}
                    </td>


                    <td class="text-right">
                        {{ (!empty($description->artist_da_amount))?number_format
                ...
                <tr>
                    ...
                    <td colspan=" 2" style="text-align:right">{{
                                eng2bnNumber(number_format($total_amount,
                                    2,'.','')) }}</td>
                </tr>
