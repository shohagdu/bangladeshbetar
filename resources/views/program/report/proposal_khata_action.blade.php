                ...
                <table style="width:100%;border:1px solid #d0d0d0" rules="all" class="table table-bordered "
                  ...
                  //  print_r($program_info);
                    ...
                    <tr>
                        ...
                        <td>
                            {{   'টিএ: '.number_format($row->artist_ta_amount,2,',','')  }}
                            {{
                       'ডিএ: '. number_format($row->artist_da_amount,2,'.','') }}
                            {{ 'খেতাব প্রাপ্ত: '. (($row->khetab_prapto==1)?'হ্যাঁ':'না') }}
                        </td>
                        <td>  {{ 'সম্মানী: '. $row->artist_grade_amount }}

                            {{ 'মহড়া: '.$row->mohoda_amount }}
                            <div class="clearfix"></div>
