    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <h2>{{ $page_title }}</h2>
                <a href="{{ url('program_recording_list') }}" class="btn btn-info btn-xs"
                   style="float:right;
                margin-top:5px;margin-right:5px;"><i class="glyphicon glyphicon-list"></i>
                    রেকডিং লিস্ট
                </a>
                <a href="{{ url('recording_performance_khata') }}" class="btn btn-primary btn-xs"
                   style="float:right;
            ...
            <div>
                <div class="widget-body no-padding">
                    <div class="col-sm-12">
                        ...
                        {!! Form::open(['url' => '', 'method' => 'post','id' => 'searchRecordingPerformanceInfoFrom',
