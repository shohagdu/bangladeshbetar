            ...
            <div class="widget-body no-padding">
                ...
                <div class="col-sm-12" style="margin-top:10px;margin-bottom:80px;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select id="onurup_ids" placeholder="অনুরুপ" multiple  class="select2" name="onurup_ids[]">
                    ...
                    <table class="table-bordered table">
                        ...
                        <thead>
                            ...
                            <tr>
                                <td style="width:6%">বার</td>
                                <td style="width:8%">সপ্তাহ</td>
                                <td style="width:8%">সময়</td>
                                <td style="width:10% !important;">অনুষ্ঠানের নাম</td>
                                <td style="width:8%">অনুষ্ঠানের বিবরন</td>
                                <td style="width:10% !important;">বিষয়বস্তু</td>
                                <td style="width:8%">স্থিতি</td>
                                <td style="width:8%">মন্তব্য</td>
                                <td style="width:5%">রেকর্ড</td>
                                <td style="width:8%">প্রযোজনা</td>
                                <td style="width:8%">তত্বাবধানে</td>
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    <button  type="submit" id="saveBtn" class="btn btn-success btn-lg btn-block"><i
                                                class="glyphicon
                                    glyphicon-save"></i> Save</button>
                                </td>
                            </tr>
                        </tfoot>
