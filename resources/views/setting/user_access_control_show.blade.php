            ...
            <div>
                <div class="widget-body no-padding"  >
                    <div class="col-sm-12" >
                        ...
                        <div class="no-print">
                            {!! Form::open(['url' => '', 'method' => 'post', 'id' => 'user_access_info_form',
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="checkbox">
                                                            <label><input value="{{ $sub_menu->id }}" name="access[{{ $modules->link
                                                            }}][{{
                                                            $main_menu->link }}][{{ $sub_menu->link }}][add]"
                                                                          type="checkbox"
                                                                          value="">Add</label>
                                                            <label><input  value="{{ $sub_menu->id }}" name="access[{{ $modules->link }}][{{
                                                            $main_menu->link }}][{{ $sub_menu->link }}][edit]"
                                                                          type="checkbox" value="">Edit</label>
                                                            <label><input  value="{{ $sub_menu->id }}" name="access[{{ $modules->link }}][{{
                                                            $main_menu->link }}][{{ $sub_menu->link }}][delete]"
                            ...
                            <div class="modal-footer">
                                ...
                                <input type="hidden" value="{{ $segment2 =  Request::segment(2) }}"  name="user_id"
                                       id="user_id">
