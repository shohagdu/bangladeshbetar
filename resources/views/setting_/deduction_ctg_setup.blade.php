                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($singleData->is_default!=1)
                                            ...
                                            <button type="button" onclick=" deleteSetupConfirm('{{ $singleData->id }}','deduction_ctg_setup')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> </button>
                                        @endif
                                    </td>
