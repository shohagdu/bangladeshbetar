                            ...
                            @foreach($setup_info as $singleData)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        @if($singleData->is_default!=1)
                                            <button type="button"data-toggle="modal" data-target="#exampleModal" onclick="UpdateSubCtgSetupInfo('{{ $singleData->id }}','{{ $singleData->title }}','{{ $singleData->is_active }}','{{ $singleData->parent_id }}')" class="btn btn-primary btn-xs">
