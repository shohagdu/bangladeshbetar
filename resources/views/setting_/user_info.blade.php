    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <h2>{{ ($type==1)?'User':'Customer' }} Information  </h2>
            </header>
                ...
                <div class="widget-body no-padding">
                    <div class="col-sm-12">
                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                            ...
                            $i=1;
                            ?>
                            @foreach($user_info as $singleData)
                                <tr>
                                    <td>  {{ $i++  }}</td>
                                    ...
                                    <td>
                                        <button type="button"data-toggle="modal" data-target="#exampleModal" onclick="updateData('{{ $singleData->id }}','{{ $singleData->name }}','{{ $singleData->mobile }}','{{ $singleData->email }}','{{ '' }}','{{ $singleData->employee_id }}')" class="btn btn-primary btn-xs">
                                            <i class="glyphicon glyphicon-pencil"></i> Update
                                        </button>
                                        <button type="button" title="Impersonate"  onclick="impersonateUserAccount('{{ $singleData->id }}')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-share-alt"></i> Access </button>
                                    </td>
