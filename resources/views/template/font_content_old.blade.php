                    ...
                    <div class="col-sm-4">
                        <table class="table table-striped table-hover "
                            ...
                            <tr>
                                ...
                                <td>:  {{ (isset(session('user_info')->name) && !empty(session('user_info')->name))?session('user_info')->name:'' }}</td>
                            </tr>
                            <tr>
                                <th style="width:130px;">Department</th>
                                <td>: {{ (isset(session('user_info')->department_title) && !empty(session('user_info')->department_title))?session('user_info')->department_title:'' }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>Mobile</th>
                                <td>: {{ (isset(session('user_info')->mobile) && !empty(session('user_info')->mobile))?session('user_info')->mobile:'' }}</td>
                            </tr>
                        ...
                        <table class="table table-bordered table-striped table-hover "
                            ...
                            @if(!empty($time_table))
                                @foreach($time_table as $time)
                                    <tr>
                                        <td>{{ $time['day'] }}</td>
                                        <td>{{ ($time['checked']==1)?date('h:i a',strtotime($time['start_time'])):'' }}</td>
                                        <td>{{ ($time['checked']==1)?date('h:i a',strtotime($time['end_time'])):'' }}</td>
                                    </tr>
