    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <a href="<?php echo e(url('presentation_proposal_info')); ?>" class="btn btn-info btn-xs no-print"
                   style="float:right;
                margin-top:5px;margin-right:5px;"><i class="glyphicon glyphicon-list"></i>
                    প্রস্তাব (Proposal)
                </a>
                <a href="<?php echo e(url('proposal_khata_presentation')); ?>" class="btn btn-primary btn-xs no-print"
                   style="float:right;
                ...
                'class'=>'form-horizontal']); ?>
                        ...
                        <div class="form-group no-print">
                            ...
                            <div class="col-md-2" style="margin-top:22px;">
                                <input type="hidden" name="presentration_type" value="<?php echo e(Request::segment(2)); ?>">
