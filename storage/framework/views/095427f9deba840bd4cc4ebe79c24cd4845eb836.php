                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if($singleData->is_default!=1): ?>
                                            ...
                                            <button type="button" onclick=" deleteSetupConfirm('<?php echo e($singleData->id); ?>','state_area_setup')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> </button>
                                        <?php endif; ?>
                                    </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-sm-8">
                        <h5 class="modal-title" id="exampleModalLabel"><span id="heading-title"></span> Area Information. </h5>
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="modal-body">
                    <div class="col-sm-12" style="margin-top:10px;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text"  id="title" class="form-control" placeholder="Enter Setup Area"  value="" name="title"/>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="hidden" value="25" name="type" id="type">
                        <input type="hidden" value="state_area_setup" name="redirect_page" id="redirect_page">
