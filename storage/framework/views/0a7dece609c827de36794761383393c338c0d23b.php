                    ...
                    <div class="col-sm-12">
                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                            ...
                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $singleData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>  <?php echo e($i++); ?></td>
                                    <td>  <?php echo e($singleData->song_category); ?></td>
                                    ...
                                    <td>
                                        <button type="button"data-toggle="modal" data-target="#exampleModal" onclick="UpdateSetupInfo('<?php echo e($singleData->id); ?>','<?php echo e($singleData->name); ?>','<?php echo e($singleData->is_active); ?>','<?php echo e($singleData->parent_id); ?>')" class="btn btn-primary btn-xs">
                                            <i class="glyphicon glyphicon-pencil"></i>
                                        </button>
                                        <button type="button" onclick=" ArchiveCategoryDelete('<?php echo e($singleData->id); ?>')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> </button>
                                    </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-sm-12" style="margin-top:10px;">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label"><?php echo e($main_title); ?></label>
                            <div class="col-md-9">
                                <select required class="form-control" id="parent_id" name="parent_id">
                                    <option value="">সংগীতের প্রকার</option>
                                    <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" required  id="title" class="form-control" placeholder="<?php echo e($page_title); ?>"  value="" name="name"/>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-sm-6">
                        <button type="button" onclick="ArchivesaveSetupInfo('save_archive_category')" id="saveBtn" class="btn btn-success"><i class="glyphicon glyphicon-save"></i> Save</button>
                        <button type="button" onclick="ArchivesaveSetupInfo('save_archive_category')" id="updateBtn" class="btn btn-success"><i class="glyphicon glyphicon-save"></i> Update</button>
