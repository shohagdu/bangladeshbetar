                ...
                <div class="widget-body no-padding">
                    <div class="col-sm-12" >
                        ...
                        <table style="width:100%;border:1px solid #d0d0d0" rules="all"  class="table table-bordered"
                            ...
                            ?>
                            <tr>
                                <td><?php echo e(!empty($station_info->name)?$station_info->name:''); ?></td>
                                <td><?php echo e($songit_info->first_line); ?></td>
                                <td><?php echo e($songit_info->name); ?></td>
                                <td>
                                ...
                                <td><?php echo e(!empty($songit_info->artist)  ? get_shilpi_name_by_ids($songit_info->artist) : ''); ?></td>
                                <td><?php echo e(!empty($songit_info->gitikar)  ? get_shilpi_name_by_ids($songit_info->gitikar) : ''); ?></td>
                                <td><?php echo e(!empty($songit_info->surokar)  ? get_shilpi_name_by_ids($songit_info->surokar) : ''); ?></td>
                                <td><?php echo e($songit_info->rating); ?></td>
                                <td><?php echo e(!empty($songit_info->type_id)?get_name_by_ids('archive_archiveing_type',$songit_info->type_id):''); ?></td>
                                <td><?php echo e($songit_info->stability); ?></td>
                                <td><?php echo e(get_source_name($songit_info->source_id)); ?></td>
                                <td><?php echo e($songit_info->recording_date); ?></td>
                                <td><?php echo e($songit_info->first_broadcast_date); ?></td>
                                <td><?php echo e(get_participant($songit_info->participant)); ?></td>
                            </tr>
