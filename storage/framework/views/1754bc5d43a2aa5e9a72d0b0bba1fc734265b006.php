    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <a href="<?php echo e(url('program_magazine_create')); ?>" class="btn btn-primary btn-xs" style="float:right;margin-top:5px;margin-right:5px;"><i class="glyphicon glyphicon-list"></i>
                    Program List
                </a>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <th colspan="14">
                                                ...
                                                <a style="float:right;margin-left:10px !important;" href="<?php echo e(url
                                                ('artist_record_add')); ?>"
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <td style="width:200px;">
                                                <input readonly disabled type="text" placeholder="বিবরন" value="<?php echo e($value); ?>" id="manage_title_<?php echo e($key); ?>" name="manage_title[]" class="form-control">
                                                <input type="hidden" placeholder="বিবরন" value="<?php echo e($key); ?>" id="manage_title_id_<?php echo e($key); ?>" name="manage_title_id[]" class="form-control">

                                            </td>
                                            <td >
                                                <select id="magazine_manage_<?php echo e($key); ?>" placeholder="<?php echo $value; ?>" class="select2" multiple required name="magazine_manage[<?php echo e($key); ?>][]" style="width:100%; !important">
                                            ...
                                            <td style="width:100px;"><button type="button" id="delete_manage_<?php echo e($key); ?>"
                                                                   class="btn
                        ...
                        <div class="form-group" id="experience_info_show" style="display:none;">
                            ...
                            <div class="col-sm-3">
                                <select  name="expertise" onchange="get_artist_expertise_info_filter()"
                                 ...
                                 artist_expertise"><option value="">দক্ষতা চিহ্নিত করুন</option> <?php if(!empty($expertise_dept)): ?>
                            ...
                            <div class="col-sm-8">
                                ...
                                <select name="aritist_vumika[]"   id="aritist_vumika" class="form-control" >
                                    <?php if(!empty($program_description)): ?>
                                        <?php $__currentLoopData = $program_description; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option  value="<?php echo e($key); ?>" ><?php echo e($value); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                </select>
