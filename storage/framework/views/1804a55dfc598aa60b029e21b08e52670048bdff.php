                    ...
                    <div class="col-sm-12">
                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                            ...
                            <tr>
                                ...
                                <th >শিল্পীর দক্ষতা</th>
                                <th> শিল্পীর দক্ষতার বিভাগ</th>
                                <th>স্ট্যাটাস </th>
                                    ...
                                    <td>
                                        ...
                                        <?php if($singleData->is_default!=1): ?>
                                            <button type="button"data-toggle="modal" data-target="#exampleModal"
                                                    onclick="UpdateSubCtgSetupInfo('<?php echo e($singleData->id); ?>','<?php echo e($singleData->title); ?>','<?php echo e($singleData->is_active); ?>','<?php echo e($singleData->parent_id); ?>')" class="btn btn-primary btn-xs">
                                                <i class="glyphicon glyphicon-pencil"></i>
                                            </button>
                                            <button type="button" onclick=" deleteSetupConfirm('<?php echo e($singleData->id); ?>','program_ctg_setup')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> </button>
                                        <?php endif; ?>
                                    </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-sm-8">
                        <h5 class="modal-title" id="exampleModalLabel">শিল্পীর দক্ষতার বিভাগ </h5>
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="modal-body">
                    <div class="col-sm-12" style="margin-top:10px;">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label"> শিল্পীর দক্ষতা</label>
                            <div class="col-md-10">
                                <select id="product_ctg" class="form-control"    name="product_ctg">
                                    <option value="">চিহ্নিত করুন</option>
                                    <?php if(!empty($parent_setup_info)): ?>
                                        <?php $__currentLoopData = $parent_setup_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ctg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">শিল্পীর দক্ষতার বিভাগ</label>
                            <div class="col-md-10">
                                <input type="text"  id="title" class="form-control" placeholder="শিল্পীর দক্ষতার বিভাগ"  value="" name="title"/>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="hidden" value="20" name="type" id="type">
                        <input type="hidden" value="artist_expertise_department" name="redirect_page" id="redirect_page">
