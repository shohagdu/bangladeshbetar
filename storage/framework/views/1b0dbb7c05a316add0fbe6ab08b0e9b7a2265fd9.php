...
'class'=>'form-horizontal']); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            ...
            <a href="<?php echo e(url('archive_book?archive_type=4')); ?>">
...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        ?>
        <span class="badge">
                                                <?php echo e(get_program_key_text($key_id)); ?>

            <?php
            foreach(array_unique($_REQUEST[get_program_key_name($key_id)]) as $index  =>  $value) {
            echo $value;
            ?>
                                                <a href="<?php echo e(get_request_url(get_program_key_name($key_id),$index)); ?>">
                                                    <i style="color:darkred" class="fa fa-close"></i>
                                                </a>
                                                <?php
            }
