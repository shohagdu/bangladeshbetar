...
<?php $__env->startSection('title_area'); ?>
    ::  এডহক উপস্থাপনা তথ্য সমুহ (প্রস্তাব)    ::
    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <h2>এডহক উপস্থাপনা তথ্য সমুহ (প্রস্তাব) </h2>

                <a href="<?php  echo asset('/proposal_khata_presentation/adhok');?>"
                                       ...
                                       $singleData->created_by_title:''); ?></td>
                                        <td>
                                            ...
                                            <button onclick="approvedPresentationInfo('<?php echo e($singleData->months); ?>',
                                                    '<?php echo e($singleData->station_id); ?>',3,2)"
