                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                            ...
                            <?php $__currentLoopData = $setup_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $singleData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>  <?php echo e($singleData->display_position); ?></td>
                                    <td>
                                        ...
                                        <?php if($singleData->is_default!=1): ?>
                                            <button type="button"data-toggle="modal" data-target="#exampleModal"
                                                    onclick="UpdateSubCtgSetupInfo('<?php echo e($singleData->id); ?>','<?php echo e($singleData->title); ?>','<?php echo e($singleData->is_active); ?>','<?php echo e($singleData->parent_id); ?>','<?php echo e($singleData->display_position); ?>')" class="btn btn-primary btn-xs">
