    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <h2> অধিবেশন প্রোগ্রাম  কিউসিট</h2>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a title="View" href="<?php  echo asset("/view_quesheet_info/"
                                                ...
                                                <i class="glyphicon glyphicon-share-alt"></i> Queue Sheet
                                            </a>

                                            <a title="Duty Room" href="<?php  echo asset("/odivision_program_queue_sheet_update/"
                                                .$info->id);?>" class="btn btn-success btn-xs">
                                                <i class="glyphicon glyphicon-pencil"></i> Duty Room
                                            </a>
                                            <a href=" <?php  echo asset('/odivision_program_queue_sheet_view_data/'.$info->id);?>" class="btn
                btn-info
                btn-xs no-print" style=" margin-top:5px;margin-right:5px;
