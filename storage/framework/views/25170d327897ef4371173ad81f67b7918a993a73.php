        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-sm-8">
                        <h5 class="modal-title" id="exampleModalLabel">অনুষ্ঠানের বিবরন </h5>
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="hidden" value="16" name="type" id="type">
                        <input type="hidden" value="program_description_setup" name="redirect_page" id="redirect_page">
