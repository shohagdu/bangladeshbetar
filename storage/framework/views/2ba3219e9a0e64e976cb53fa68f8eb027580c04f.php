        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-sm-6">
                        <button type="button" onclick="ArchivesaveSetupInfo('save_archive_angik')" id="saveBtn" class="btn btn-success"><i class="glyphicon glyphicon-save"></i> Save</button>
                        <button type="button" onclick="ArchivesaveSetupInfo('save_archive_angik')" id="updateBtn" class="btn btn-success"><i class="glyphicon glyphicon-save"></i> Update</button>
