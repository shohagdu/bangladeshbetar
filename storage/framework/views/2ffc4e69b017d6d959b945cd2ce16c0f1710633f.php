                    ...
                    !important;">
                        ...
                        <table  id="table-style" style="width: 100%;">
                            <tr>
                                ...
                                <td class="<?php echo e((!empty($artist_info_show->is_active) &&
                                        $artist_info_show->is_active==2) ?
                           "Inactive":'Active'); ?> width30per"><?php echo e((!empty($artist_info_show->is_active) &&
                                        $artist_info_show->is_active==2) ?
                           "Inactive":'Active'); ?> </td>
                                ...
                                <td class="width20per text-center" rowspan="4">
                                    <span >
                                    <img src="<?php echo e((file_exists("fontView/assets/artist_signature/"
                            ...
                            <tr>
                                ...
                                <td class=" width30per"><?php echo e((!empty($artist_info_show->artist_doptor) &&
                            ...
                            <tr>
                                ...
                                <td class="width30per">
                                    ...
                                    <?php echo e((!empty($artist_info_show->artist_type) &&
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if(!empty($artist_info_show->station_name )): ?>
                                        <?php echo e($artist_info_show->station_name); ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo e((empty($artist_info_show->enlisted_last_date) ||
                                ...
                                <td class="width30per">
                                    <?php echo e((empty($artist_info_show->enlisted_date) ||
                            ...
                            <tr>
                                ...
                                <td> <?php echo e(!empty($artist_info_show->name_bn)?
                                $artist_info_show->name_bn:''); ?></td>
                                <td class="">শিল্পীর সংক্ষিপ্ত নাম</td>
                                <td><?php echo e($artist_info_show->artist_short_name); ?> </td>
                            </tr>

                            <tr>
                                <td class=""> শিল্পীর নাম (ইংরেজী)</td>
                                <td> <?php echo e(!empty($artist_info_show->name)?
                                $artist_info_show->name:''); ?></td>
                                <td class="">জাতীয় পুরষ্কার প্রাপ্ত</td>
                                <td>
                                    <?php echo e(!empty($artist_info_show->national_awarded_title) ?
                            ...
                            <tr>
                                ...
                                <td><?php echo e(!empty($artist_info_show->father_name)?
                                $artist_info_show->father_name:''); ?> </td>
                                <td class="">পেশা</td>
                                <td> <?php echo e(!empty( $artist_info_show->artist_occupation)
                                          ?trim($artist_info_show->artist_occupation):''); ?></td>
                            </tr>
                            <tr>
                                <td class=""> মাতার নাম</td>
                                <td><?php echo e(!empty( $artist_info_show->
                                mother_name)? $artist_info_show->
                                mother_name:''); ?> </td>
                                <td class="">জাতীয়তা</td>
                                <td>
                                    <?php echo e(!empty($artist_info_show->nationality_title) &&
                            ...
                            <tr>
                                <td class=""> <?php echo e(!empty($artist_info_show->is_husband_wife) &&
                                            ($artist_info_show->is_husband_wife == 1) ?
                                            'স্বামীর': (($artist_info_show->is_husband_wife == 2) ?
                                            'স্ত্রীর':'')); ?> নাম
                                </td>
                                <td><?php echo e(!empty($artist_info_show->husband_wife_name)?
                                $artist_info_show->husband_wife_name:''); ?> </td>
                                <td class="">জেলা</td>
                                <td>
                                    <?php echo e(!empty($artist_info_show->district_title) &&
                            ...
                            <tr>
                                <td class=""> ঠিকানা</td>
                                <td> <?php echo e(!empty($artist_info_show->address)?
                                $artist_info_show->address:''); ?></td>
                                <td class="">শিক্ষাগত যোগ্যতা</td>
                                <td> <?php echo e(!empty($artist_info_show->educational_info)?$artist_info_show->educational_info:''); ?></td>
                            </tr>
                            <tr>
                                <td class=""> মোবাইল</td>
                                <td> <?php
                                    ...
                                    <div id="mobile_no_log_info_<?php echo e($indexed); ?>">
                                        <div class="col-sm-8">
                                            <div class="row">
                                                <b><?php echo e($indexed); ?>.</b> <?php echo e($mobile); ?>
                                    ...
                                    ?></td>
                                <td class="">ই-মেইল</td>
                                <td><?php echo e(!empty($artist_info_show->email)?
                                $artist_info_show->email:''); ?> </td>
                            </tr>
                            <tr>
                                <td class="">ফেইসবুক আইডি(Facebook ID)</td>
                                <td colspan="3"> <?php echo e(!empty($artist_info_show->fb_id_link)?
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e((!empty($artist_info_show->bank_name_title) &&
                         ...
                         $artist_info_show->bank_name_title:''); ?>
                                ...
                                <td><?php echo e(!empty($artist_info_show->bank_branch_name)?
                                $artist_info_show->bank_branch_name:''); ?> </td>
                            </tr>
                            <tr>
                                <td class=""> ব্যাংক একাউন্ট নং</td>
                                <td><?php echo e(!empty($artist_info_show->bank_account_no)?
                            ...
                            <tr>
                                <td colspan="4">
                                    <table class="table-bordered table" style="width: 100%;">
                                        ...
                                        <tr>
                                            <td><?php echo e(!empty($artist_info_show->fixed_amount)?
                                $artist_info_show->fixed_amount:''); ?></td>
                                            <td><?php echo e(!empty($artist_info_show->per_day_amount)?
                                $artist_info_show->per_day_amount:''); ?></td>
                                            <td><?php echo e(!empty($artist_info_show->total_days)?
                            ...
                            <tr>
                                <td colspan="4">
                                    <table class="table table-bordered" style="width: 100%;">
                                        ...
                                        <tr>
                                            <td>
                                                <?php echo e((!empty ( $expertise['expertise']) &&  $expertise['expertise']==!'') ?
                               $expertise['expertise']:''); ?>


                                            </td>
                                            <td>
                                                <?php echo e((!empty  ( $expertise['expertise_dept']) &&    $expertise['expertise_dept']==!'') ?$expertise['expertise_dept']:''); ?>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php echo e((!empty($rate_chart['chart_description']) &&
                                                $rate_chart['chart_description']==!'') ?$rate_chart['chart_description']:''); ?>


                                            </td>
                                            <td>
                                                <?php echo e((!empty    ( $rate_chart['artist_grade']) &&
