...
<link rel="stylesheet" type="text/css" media="screen" href="<?php echo e(asset('fontView')); ?>/assets/css/font-awesome.min.css">
...
<div style="height: 800px;">
    <div class="col-sm-12 text-center" style="font-weight: bold;">
        <h3>Salary Payslip of <?php echo e($payslip_info->month_title); ?></h3>
    </div>
        ...
        <tr>
            <td style="width:40%">
                <table class="width100per  payslip_pdf">
                    <tr>
                        <td class="width20per">Employee ID: <?php echo e($payslip_info->employee_id); ?></td>
                    </tr>
                    <tr>
                        <td class="width20per">Name: <?php echo e($payslip_info->emp_name); ?></td>
                    </tr>
                    <tr>
                        <td>Department: <?php echo e($payslip_info->department_title); ?></td>
                    </tr>
                    <tr>
                        <td>Designation : <?php echo e($payslip_info->designation_title); ?></td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="width:42%;margin-right:6%;">
                <table class="width100per  payslip_pdf">
                    ...
                    ?>
                    <tr>
                        <td><?php echo e($row['earning_ctg_title']); ?></td>
                        <td class="text-right"><?php echo e($row['earning_ctg_amount']); ?></td>
                    ...
                    <tr>
                        ...
                        <td id="total_earning" class="text-right"><?php echo e(number_format($total_earning,2,'.','')); ?></td>
                    </tr>
                </table>
            </td>
            ...
            <td style="width:42%;">
                <table class="width100per  payslip_pdf">
                    ...
                    ?>
                    <tr>
                        <td><?php echo e($row['deduction_ctg_title']); ?></td>
                        <td class="text-right"><?php echo e($row['deduction_ctg_amount']); ?></td>
                    ...
                    <tr>
                        ...
                        <td class="text-right"><span
                                    id="total_deduction"><?php echo e(number_format($total_deduction,2,'.','')); ?></span></td>
                    </tr>
                </table>
        ...
        <tr>
            <td>
                <table class="width70per  payslip_pdf text-center ">
                    <tr>
                        ...
                        <th class="text-right"><?php echo e(number_format($total_earning,2,'.','')); ?></th>
                    </tr>
                    <tr>
                        <th>Deduction:</th>
                        <th class="text-right"><?php echo e(number_format($total_deduction,2,'.','')); ?></th>
                    </tr>
                    <tr>
                        <th>Net Paid:</th>
                        <th class="text-right"><?php echo e(number_format($total_earning-$total_deduction,2,'.','')); ?></th>
                    </tr>
                </table>
            </td>
            <td class="float:right">
                <table class="width100per  leave_info_pdf">
                    ...
                    <?php if(!empty($payslip_info->lave_info)): ?>
                        <?php $__currentLoopData = json_decode($payslip_info->lave_info,true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
    ...
    <div class="col-sm-12 ">
        <b>Net Paid In Word:</b><?php echo e($payslip_info->in_word); ?>
...
<div class="col-sm-12">
    ...
    date: <?php echo e($payslip_info->generated_date); ?>
