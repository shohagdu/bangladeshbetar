                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if($singleData->is_default!=1): ?>
                                            ...
                                            <button type="button" onclick=" deleteSetupConfirm('<?php echo e($singleData->id); ?>','bank_info_setup')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> </button>
                                        <?php endif; ?>
                                    </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-sm-8">
                        <h5 class="modal-title" id="exampleModalLabel"><span id="heading-title"></span> Earning Bank Information. </h5>
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="hidden" value="bank_info_setup" name="redirect_page" id="redirect_page">
