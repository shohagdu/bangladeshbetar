                    ...
                    <div class="col-sm-12" >
                        ...
                        <table style="width:100%;border:1px solid #d0d0d0" rules="all"  class="table table-bordered"
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e(get_participant($item_info->participant)); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e(!empty($item_info->source_id)?get_name_by_id('archive_song_source',['id'=>$item_info->source_id])->name:''); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e($item_info->story_summary); ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($item_info->main_story); ?></td>
                                <td class="text-bold">ছায়া গ্লপ</td>
                                <td colspan="5">
                                    <?php echo e($item_info->chaya_story); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e(!empty($item_info->rochoyita)  ? get_shilpi_name_by_ids($item_info->rochoyita) : ''); ?>
                                ...
                                <td>
                                    <?php echo e(!empty($item_info->sound_editors)  ? get_shilpi_name_by_ids($item_info->sound_editors) : ''); ?>
