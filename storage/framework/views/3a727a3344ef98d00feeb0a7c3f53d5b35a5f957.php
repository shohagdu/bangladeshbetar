                    ...
                    <div class="col-sm-12" >
                        ...
                        <table style="width:100%;border:1px solid #d0d0d0" rules="all"  class="table table-bordered"
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e(!empty($item_info->type_id)?get_name_by_ids('archive_archiveing_type',[$item_info->type_id]):''); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e(!empty($item_info->album_id)?get_name_by_ids('archive_albam',$item_info->album_id):''); ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($item_info->gronth_name); ?></td>
                                <td class="text-bold">কবিতার লাইন</td>
                                <td colspan="5">
                                    <?php echo e($item_info->kobita_line); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e(!empty($item_info->abritikar)  ? get_shilpi_name_by_ids($item_info->abritikar) : ''); ?>
