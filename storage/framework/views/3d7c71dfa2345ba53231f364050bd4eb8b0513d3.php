...
<head>
    ...
    <title>
        <?php if(View::hasSection('title_area')): ?>
            <?php echo $__env->yieldContent('title_area'); ?>
        <?php else: ?>
            :: Report ::Bangladesh Betar::
        <?php endif; ?>
    </title>
...
<?php echo $__env->make('template.include.left_bar_archive', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<!-- END NAVIGATION -->
...
<div class="page-footer">
    <div class="row">
        <div class="col-xs-12 col-sm-6 no-print">
            <span class="txt-color-white">  All right reserved at 2019-<?php echo date('Y') ?>.  Design & Developed By <span class="hidden-xs">  <a href="http://www.betar.gov.bd/" target="_blank">Bangladesh Betar</a> </span></span>
        </div>
...
<script data-pace-options='{ "restartOnRequestAfter": true }' src="<?php echo e(asset('fontView')); ?>/assets/js/plugin/pace/pace.min.js"></script>
...
<!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.0.0/jquery.min.js"></sc ript> -->
...
<script src="<?php echo e(asset('fontView')); ?>/assets/modules/js/archive.js"></script>
