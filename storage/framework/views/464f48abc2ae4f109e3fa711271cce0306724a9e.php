    ...
    <article class="col-sm-12 col-md-12 col-lg-12 padding-bottom-10px">
        ...
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <h2>Details Employee Information </h2>
                <a href="<?php  echo asset('/employee_info/');?>"
                   class="btn btn-primary btn-xs topbarbutton"><i
                            class="glyphicon glyphicon-backward"></i>
                    Employee Record
                </a>

                <a href="<?php  echo asset('/details_employee_info/' . md5($employee_info->id) . '/' . $employee_info->id . '/pdf');?>"
                    ...
                    <div class="col-sm-12">
                        ...
                        <table class="width100per" id="employee_details">
                                ...
                                <td colspan="4" class="no-border">
                                    <table class="width100per">
                                        <tr>
                                            ...
                                            <td class="width10per vertical-align-top no-border">
                                                <img src="<?php echo e(((file_exists('images/employee_image/'.$employee_info->image) && !empty($employee_info->image) )?url('images/employee_image/'.$employee_info->image):url('images/default/default-avatar.png'))); ?> "
                                                     alt="Bangladesh Betar"
                                                     style="height: 120px;width:153px; border: 1px solid #d0d0d0;">
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                ...
                                <td>: <b>Vill/House/Road</b>: <?php echo e($present_address->vill_road); ?>, <b>Post Office</b>: <?php echo e($present_address->post_office); ?>, <b>Police Station</b>:<?php echo e($present_address->upazila); ?>, <b>District</b>: <?php echo e($present_address->district); ?>

                                </td>
                                <th class="emp-text-right vertical-align-top">Parmanent Address</th>
                                <td>:
                                    <?php if(!empty($parmanent_address)): ?>
                                        <b>Vill/House/Road</b>:<?php echo e($parmanent_address->vill_road); ?>, <b>Post Office</b>: <?php echo e($parmanent_address->post_office); ?>, <b>Police  Station</b>: <?php echo e($parmanent_address->upazila); ?>, <b>District</b>:<?php echo e($parmanent_address->district); ?>
                            ...
                            <tr>
                                <td colspan="2" class="vertical-align-top">
                                    <table  class=" table-bordered width100per leave_info_pdf">
                                        <tr>
                            ...
                            <tr>
                                <th>Home District</th>
                                <td>: <?php echo e($spouse_info['spouse_home_district']); ?></td>
