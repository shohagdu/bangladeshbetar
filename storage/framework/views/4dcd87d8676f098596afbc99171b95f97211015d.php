                ...
                <div class="widget-body no-padding">
                    <div class="col-sm-12">
                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                            ...
                            <tr>
                                <th>কেন্দ্র</th>
                                <th>সাক্ষাৎ প্রদানকারীর নাম</th>
                                <th>সাক্ষাৎ প্রদানের তারিখ </th>
                                <th>বিষয়</th>
                                <th>ধরন</th>
                            ...
                            $sakhhatkar_info = json_decode($row->sakhhatkar_info);
                            ?>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <?php echo $sakhhatkar_info->sakhhat_data ?>
                                </td>
                                <td>
                                    <?php  echo $sakhhatkar_info->grohoner_date ?>
                                </td>
                                <td>
                                    <?php echo $sakhhatkar_info->subject ?>
                                </td>
                                <td>
                                    <?php
                                    $category_info =  get_name_by_id('archive_category',['id' =>$sakhhatkar_info->category]);
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0)" title="Play" class="btn btn-primary btn-xs playbtn" id="<?php echo "btn".$row->id ?>"
                                       onClick="audioAction('<?php  echo  $sakhhatkar_info->file_directory.'/'.$sakhhatkar_info->file_name; ?>',<?php  echo $row->id; ?>);">
