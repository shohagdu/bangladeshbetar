                    ...
                    <div class="col-sm-12" >
                        ...
                        <table class="print_table-no-border " style="width:100%;border: 1px solid #fff !important;">
                            <tr>
                                <td    style="text-align: center;width:40%;border: 1px solid #fff!important" >
                                    ...
                                    <div style="font-size:14px;">  <?php echo e(!empty($program_plan->station_name)?$program_plan->station_name:''); ?></div>
                                    <div style="font-size:14px;"><?php echo e(!empty($program_plan->station_address)?$program_plan->station_address:''); ?></div>
                                    <div style="font-size:14px;"><?php echo e(!empty($program_plan->fequencey_data)?$program_plan->fequencey_data:''); ?></div>
                        ...
                        <table style="width:100%;border:1px solid #d0d0d0" rules="all"  class="table table-bordered"
                            ...
                            <tr>
                                ...
                                <td colspan="2" style="font-size:15px !important;font-weight: bold;"
                                    class="text-bold">
                                    <?php echo e(($program_plan->record_type==1)?"সজীব":(($program_plan->record_type==2)
                        ...
                        <!-- <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e((!empty($program_plan->live_time))? eng2bnNumber($program_plan->live_time):''); ?>
                    ...
                    <div class="col-sm-12">
                        <table style="width:100%;border:1px solid #d0d0d0" rules="all" class="table table-bordered " id="table-style">
                            ...
                            <tr>
                                ...
                                <?php if($program_plan->is_active>=3): ?>
                                    <td>#</td>
                                <?php endif; ?>
                            </tr>
...
//                                        print_r($year);
                                ...
                                <td class="text-center">
                                    <?php echo e(!empty($description->number_of_days)?eng2bnNumber
                                ...
                                <td class="text-right">
                                    <?php echo e((!empty($description->mohoda_amount))? eng2bnNumber(number_format
                                   ($description->mohoda_amount,2,'.','')):'০.০০'); ?>

                                </td>
                                <td class="text-right">
                                    <?php echo e((!empty($description->artist_ta_amount))?eng2bnNumber(number_format
                                ...
                                <td class="text-right">
                                    <?php echo e((!empty($description->artist_da_amount))?eng2bnNumber(number_format
                                ...
                                <?php if($program_plan->is_active>=3): ?>
                                    <td>
                                        ...
                                        <a href="<?php echo e(url('payment/pdf/contact_paper.php?pslip='
                            ...
                            <tr>
                                ...
                                <td colspan=" <?php echo e(1); ?> +  <?php echo e(($program_plan->is_active<=3)?1:0); ?>" class="text-right"><?php echo e((!empty($total_amount))?  eng2bnNumber(number_format($total_amount,
                                    2,'.','')):'০.০০'); ?></td>
                            </tr>
                        ...
                        <table class="table table-bordered" id="table-style" rules="all" border="1px" >
                            ...
                            ?>
                            <tr>
                                <td style="width:20%;"><?php echo e($manager_info[$key]); ?></td>
                                <td>
                                    <?php
