    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
                ...
                <a href="<?php echo e(url('archive_book?type=2')); ?>" class="btn btn-primary btn-xs"
                   style="float:right;
                ...
                <div class="widget-body no-padding">
                    <div class="col-sm-12">
                        <div class="col-sm-12" style="margin-top:10px;">
                            ...
                            <form class="form-inline" method="get"  action="">
                                <div class="form-group">
                                    <select  placeholder="বাছাই করুন" class="select2" name="created_by" style="width:120%; !important">
                                        ...
                                        <?php $__currentLoopData = $employee_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php echo e(app('request')->input('created_by') ? ( app('request')->input('created_by') == $item->id ? 'selected':'' ) :''); ?> value="<?php echo e($item->id); ?>"><?php echo e($item->emp_name); ?></option>
                            ...
                            <audio controls style="margin-left:300px" id="player">
                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                            ...
                            $kobita_info = json_decode($row->kobita_info);
                            ?>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <?php echo $kobita_info->name ?>
                                </td>
                                <td>
                                    <?php echo $kobita_info->first_line ?>
                                </td>
                                <td>
                                    <?php
                                    $category_info =  get_name_by_id('archive_archiveing_type',['id' =>$kobita_info->type_id]);
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0)" title="Play" class="btn btn-primary btn-xs playbtn" id="<?php echo "btn".$row->id ?>"
                                       onClick="audioAction('<?php  echo  $kobita_info->file_directory.'/'.$kobita_info->file_name; ?>',<?php  echo $row->id; ?>);">
                                        <i class="fa fa-play"></i></a>
                                <?php if($row->is_approve==1 && $row->status==1) { ?>
                                <!--<a href="javascript:void(0)" title="Add to Playlist" onclick="addToPlaylist(<?php //echo $row->id ?>);" class="btn btn-warning btn-xs"><i class="fa fa-list"></i></a> --->
                                    <?php } ?>
                                    <a title="View" class="btn btn-info btn-xs" href="javascript:void(0);">
                                        <i class="fa fa-eye"></i>
                                    </a>
