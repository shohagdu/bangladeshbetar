                ...
                <div class="widget-body no-padding">
                    <div class="col-sm-12">
                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                            ...
                            <tr>
                                <th>কেন্দ্র</th>
                                <th>ভাষণ প্রদানকারীর নাম</th>
                                <th>ভাষণ প্রদানের তারিখ </th>
                            ...
                            $vhason_info = json_decode($row->vhason_info);
                            ?>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <?php echo $vhason_info->vhason_kari ?>
                                </td>
                                <td>
                                    <?php  echo $vhason_info->prodaner_tarikh ?>
                                </td>
                                <td>
                                    <?php echo $vhason_info->first_line ?>
                                </td>
                                <td>
                                    <?php
                                    $category_info =  get_name_by_id('archive_category',['id' =>$vhason_info->category]);
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0)" title="Play" class="btn btn-primary btn-xs playbtn" id="<?php echo "btn".$row->id ?>"
                                       onClick="audioAction('<?php  echo  $vhason_info->file_directory.'/'.$vhason_info->file_name; ?>',<?php  echo $row->id; ?>);">
