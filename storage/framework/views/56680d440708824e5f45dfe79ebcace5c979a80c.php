                ...
                <div class="widget-body no-padding">
                    <div class="col-sm-12">
                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                            ...
                            $i=1;
                            ?>
                            <?php $__currentLoopData = $branch_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $singleData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>  <?php echo e($i++); ?></td>
                                    ...
                                    <td>
                                        <button type="button"data-toggle="modal" data-target="#exampleModal" onclick='updateBranchInfo("<?php echo e($singleData->id); ?>","<?php echo e($singleData->name); ?>","<?php echo e($singleData->mobile); ?>","<?php echo e($singleData->email); ?>","<?php echo e($singleData->is_active); ?>","<?php echo e($singleData->sorting); ?>" )' class="btn btn-primary btn-xs">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <?php echo Form::open(['url' => '/save_branch_setup', 'id'=>'branch_setup', 'method' => 'post','class'=>'form-horizontal']); ?>
