            ...
            <table class="table table-bordered width100per">
                ...
                <?php if(!empty($travel_info)): ?>
                    ...
                    <?php $__currentLoopData = $travel_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $travel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($travel['is_active']==1): ?>
                            <tr>
                                <td>  <?php echo e((!empty ($travel['type']))?(($travel['type']==1)?"Local Travel":"Foreign Travel"):''); ?>
                                ...
                                <td><button id="deleteRow_<?php echo e($kl); ?>" onclick="deleteEmployeeTravel('<?php echo e($travel['id']); ?>','<?php echo e($employe_info->employee_id); ?>')"
                                            class="deleteRow
                                btn btn-warning
...
<div class="modal fade" id="add_travel_info" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <?php echo Form::open(['url' => '/save_travel_info_form', 'id' => 'employee_travel_form','method' => 'post',
