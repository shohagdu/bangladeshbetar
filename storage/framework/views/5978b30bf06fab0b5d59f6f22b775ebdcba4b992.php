<?php $__env->startSection('title_area'); ?>
    :: এডহক উপস্থাপনা তথ্য সমুহ (পরিকল্পনা)   ::
    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <h2>এডহক উপস্থাপনা তথ্য সমুহ (পরিকল্পনা) </h2>

                <a href="<?php  echo asset('/program_adhok_presentation_add');?>"
                            ...
                            <?php if(!empty($presentation_info)): ?>
                                <?php $__currentLoopData = $presentation_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $singleData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    && $singleData->is_re_planning==1)?("background: lightgray"):'')); ?>">
                                        ...
                                        <td>
                                            <a href="<?php echo e(url('presentation_info_report/'.$singleData->months.'/'
                                            .$singleData->station_id.'/2')); ?>"
                                               class="btn btn-info btn-xs"><i class="glyphicon
                                               glyphicon-share-alt"></i> View
                                            </a>
                                            <a href="<?php echo e(url('presentation_info_report_date/'.$singleData->months.'/'
                                            .$singleData->station_id.'/2')); ?>"
                                               class="btn btn-info btn-xs"><i class="glyphicon
                                            ...
                                            <button onclick="deletePresentationInfo('<?php echo e($singleData->months); ?>',
                                                    '<?php echo e($singleData->station_id); ?>',2)"
                                            ...
                                            <button onclick="approvedPresentationInfo('<?php echo e($singleData->months); ?>',
                                                    '<?php echo e($singleData->station_id); ?>',2,2)"
