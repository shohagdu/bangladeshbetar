    ...
    <table id="print_table" rules="all" border="1px" class="table table-bordered"  style="width:100%;float: left;">
        ...
        <tr>
            <td>  <?php echo e($i++); ?></td>
            <td>
                <?php if($payrole_info['payrole_generated_status']=='NotGenerated'): ?>
                    <input type="checkbox" name="employee_id[<?php echo e($key); ?>]" id="employee_id_<?php echo e($key); ?>" value=" <?php echo e($payrole_info['employee_id']); ?>">
                 <?php endif; ?>
                 <?php if($payrole_info['payrole_generated_status']=='AlreadyGenerated'): ?>
                     <div> <?php echo e('Already Generate'); ?></div>
                 <?php endif; ?>
            </td>
            ...
            <td>
                <input type="hidden" name="payrole_earning_info[]" id="earning_info_<?php echo e($key); ?>" class="form-control" value="<?php echo e($payrole_info['payrole_earning_info']); ?>">
                <input type="hidden" name="payrole_deduction_info[]" id="earning_info_<?php echo e($key); ?>" class="form-control" value="<?php echo e($payrole_info['payrole_deduction_info']); ?>">
                ...
                <?php
                    ...
                    ?>
                    <tr>
                        <td><?php echo e($earning_ctg[$earning['earning_ctg']]); ?>  </td>
                        <td><?php echo e($earning['earning_ctg_per']); ?>  </td>
                    ...
                    <tr>
                        ...
                        <th><?php echo e(number_format($total_payable,2,'.','')); ?> </th>
                    </tr>
                </table>
            ...
            <td>
                <table class="table table-bordered" id="print_table" rules="all" border="1px">
                    ...
                    ?>
                    <tr>
                        <td><?php echo e($deduction_ctg[$deduction['deduction_ctg']]); ?></td>
                        <td><?php echo e($deduction['deduction_ctg_per']); ?> </td>
                    ...
                    <tr>
                        <th colspan="2">Total Payable</th>
                        <th><?php echo e(number_format($total_deduction,2,'.','')); ?> </th>
                    </tr>
                </table>
            </td>
            <td class="text-right">
                <?php echo e($net_paid=number_format($total_payable-$total_deduction,2,'.','')); ?>
       ...
       <?php } ?>
        <tr>
            ...
            <th class="text-right" ><?php echo e(number_format($total_net_paid,2,'.','')); ?></th>
            <td></td>
