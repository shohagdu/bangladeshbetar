    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <a href="<?php echo e(url('artist_record_add')); ?>"
                    ...
                    <div class="col-sm-12">
                        ...
                        <table id="dt_basic" class="table table-bordered">
                            ...
                            <tbody id="promanok_file_info">
                                <td><?php echo e((!empty($file['file_tile']))?$file['file_tile']:''); ?></td>
                                <td><a target="_blank" href="<?php echo e((!empty($file['file_info']))?asset
    ...
    <div id="add_promanok_file" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <?php echo Form::open(['url' => '', 'method' => 'post','id' => 'save_artist_attachment_form',
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-md-4">
                        <input type="hidden" name="artist_id" value="<?php echo e(Request::segment(2)); ?>">
