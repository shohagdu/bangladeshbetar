                    ...
                    <div class="col-sm-12" >
                        ...
                        <table style="width:100%;border:1px solid #d0d0d0" rules="all"  class="table table-bordered"
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e($item_info->vhason_kari); ?>
                                ...
                                <td class="text-bold">ভাষণের প্রকার</td>
                                <td>
                                ...
                                <td>
                                    <?php echo e($item_info->prodaner_tarikh); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e($item_info->place); ?>

                                </td>

                                <td class="text-bold">কর্মক্ষেত্র</td>
                                <td colspan="3">
