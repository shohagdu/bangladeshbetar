                    ...
                    <div class="col-sm-12" >
                        ...
                        <table style="width:100%;border:1px solid #d0d0d0" rules="all"  class="table table-bordered"
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e(!empty($item_info->angik)?get_name_by_id('archive_category',['id'=>$item_info->angik])->name:''); ?>
                            ...
                            <tr>
                                ...
                                <td colspan="8">
                                    <?php echo e(!empty($item_info->participant)  ? get_shilpi_name_by_ids($item_info->participant) : ''); ?>
