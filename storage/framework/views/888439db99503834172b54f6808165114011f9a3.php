...
<div class="no-print">
    ...
    <?php echo $__env->make('template.include.left_bar_store', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <!-- END NAVIGATION -->
</div>
<!-- MAIN PANEL -->
...
<script src="<?php echo e(asset('fontView')); ?>/assets/modules/js/store_mng.js"></script>
