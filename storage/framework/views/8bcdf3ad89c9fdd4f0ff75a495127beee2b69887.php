                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                            ...
                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $singleData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo e($singleData->prokasok); ?>

                                    </td>
                                    <td>  <?php echo e($singleData->publish_date); ?></td>
                                    ...
                                    <td>
                                        <button type="button"data-toggle="modal" data-target="#exampleModal" onclick="UpdateAlbumInfo('<?php echo e($singleData->id); ?>','<?php echo e($singleData->name); ?>','<?php echo e($singleData->prokasok); ?>','<?php echo e($singleData->publish_date); ?>','<?php echo e($singleData->is_active); ?>')" class="btn btn-primary btn-xs">
                                            <i class="glyphicon glyphicon-pencil"></i>
                                        </button>
                                        <button type="button" onclick="ArchiveAlbumDelete('<?php echo e($singleData->id); ?>')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> </button>
                                    </td>
                                </tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-sm-12" style="margin-top:10px;">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">প্রকাশক</label>
                            <div class="col-md-9">
                                <input type="text" placeholder="প্রকাশক" class="form-control" name="prokashok" id="prokashok"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">প্রকাশ তারিখ</label>
                            <div class="col-md-9">
                                <input type="text" placeholder="প্রকাশ তারিখ" class="form-control datepickerLong" name="publish_date" id="publish_date"/>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-sm-6">
                        <button type="button" onclick="ArchivesaveSetupInfo('save_archive_album')" id="saveBtn" class="btn btn-success"><i class="glyphicon glyphicon-save"></i> Save</button>
                        <button type="button" onclick="ArchivesaveSetupInfo('save_archive_album')" id="updateBtn" class="btn btn-success"><i class="glyphicon glyphicon-save"></i> Update</button>
