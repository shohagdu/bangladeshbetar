    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <h2> Product Sub Category Setup</h2>
                            ...
                            <?php $__currentLoopData = $setup_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $singleData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php endif; ?>
                                        <?php if($singleData->is_default!=1): ?>
                                            <button type="button"data-toggle="modal" data-target="#exampleModal" onclick="UpdateSubCtgSetupInfo('<?php echo e($singleData->id); ?>','<?php echo e($singleData->title); ?>','<?php echo e($singleData->is_active); ?>','<?php echo e($singleData->parent_id); ?>')" class="btn btn-primary btn-xs">
                                                <i class="glyphicon glyphicon-pencil"></i>
                                            </button>
                                            <button type="button" onclick=" deleteSetupConfirm('<?php echo e($singleData->id); ?>','product_sub_category')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> </button>
                                        <?php endif; ?>
                                    </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-sm-8">
                        <h5 class="modal-title" id="exampleModalLabel"><span id="heading-title"></span> Product Category Info. </h5>
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="modal-body">
                    <div class="col-sm-12" style="margin-top:10px;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text"  id="title" class="form-control" placeholder="Enter Sub Category"  value="" name="title"/>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="hidden" value="12" name="type" id="type">
                        <input type="hidden" value="product_sub_category" name="redirect_page" id="redirect_page">
