        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-sm-8">
                        <h5 class="modal-title" id="exampleModalLabel">  শিল্পীর দক্ষতা
                        </h5>
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="hidden" value="21" name="type" id="type">
                        <input type="hidden" value="artist_national_awared_setup" name="redirect_page" id="redirect_page">
