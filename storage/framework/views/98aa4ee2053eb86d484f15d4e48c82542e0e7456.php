    ...
    <article class="col-sm-12 col-md-12 col-lg-12 padding-bottom-10px" >
        ...
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" >
            <header>
                ...
                <h2 id="title_info_print">Employee Department Report </h2>
                <div class="no-print">
                    ...
                    <div class="col-sm-12" >
                        ...
                        <div class="no-print">
                            ...
                            <div class="col-sm-2">
                                ...
                                <select id="employee_department" class="form-control"   name="employee_department">
                            ...
                            <div class="col-sm-2 margin-top-20px">
                                <button type="button" onclick="employee_department_search()" id="search_btn" class="btn btn-success btn-sm"   name="search_btn"><i class="glyphicon glyphicon-search"></i> Search</button>
                            </div>
                            <?php echo Form::close(); ?>
