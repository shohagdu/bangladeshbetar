                    ...
                    !important;">
                        <tr>
                            <td  style="text-align: center;width:40%;border: 1px solid #fff !important; " >
                                ...
                                <div style="font-size:14px;"><?php echo e($playlist->station_name); ?></div>
                                <div style="font-size:14px;"><?php echo e($playlist->address); ?></div>
                                <div style="font-size:14px;"><?php echo e($playlist->sub_station_name. '('.$playlist->fequencey.')'); ?></div>
                                <div class="clearfix"></div>
                                <div class="clearfix"></div>
                                <p><b> অনুষ্ঠানের নাম: </b> <?php echo e($playlist->program_name); ?> </p>
                                <p style="padding-left:10px;line-height: 10px;"><b>অনুষ্ঠানের বিষয়:</b> <?php echo e($playlist->program_subject); ?></p>
                                <span style="padding-left:10px;line-height: 10px;"><b>প্রচার তারিখ:</b> <?php echo e($playlist->boardcast_date); ?></span>
                                <span style="padding-left:10px;line-height: 10px;"><b>প্রচার সময়:</b> <?php echo e($playlist->boardcast_time); ?></span>
                            </td>
                        </tr>
...
//                                        dd($item_info);
                                ...
                                <table class="print_table-no-border" style="width: 100%;margin-bottom:
                                    ...
                                    <tr>
                                        ...
                                        <u>প্লেলিস্ট আইডি : </u>
                                            <?php echo e($playlist->playlist_id); ?>

                                        </td>
                                        <td style="width:25%;text-align: center;font-size:11px; " class="no-border"> <span>
                                                            <u>পরিকল্পনাকারী:</u>
                                                        <?php echo e(get_employee_name_by_ids([$playlist->planner_id])); ?>
