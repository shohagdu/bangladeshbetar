    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header  >
                    ...
                    <a href="<?php echo e(url('program_magazine_create')); ?>" class="btn btn-info btn-xs no-print"
                       style="float:right;
                margin-top:5px;margin-right:5px;"><i class="glyphicon glyphicon-list"></i>
                        পরিকল্পনা (Planning)
                    </a>
                    <a href="<?php echo e(url('program_proposal_khata')); ?>" class="btn btn-primary btn-xs no-print"
                       style="float:right;
            ...
            <div>
                <div class="widget-body no-padding">
                    <div class="col-sm-12">
                        ...
                        <?php echo Form::open(['url' => '', 'method' => 'post','id' => 'searchPlanningInfoFrom',
