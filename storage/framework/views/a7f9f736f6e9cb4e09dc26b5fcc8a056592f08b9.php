    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
                        ...
                        <table class="table-bordered table">
                            <tr>
                                ...
                                #fff!important" >
                                    ...
                                    <div style="font-size:14px;"><?php echo e($heading_performance_info->name); ?></div>
                                    <div style="font-size:14px;"><?php echo e($heading_performance_info->address); ?></div>
                                    <div style="font-size:14px;"><?php echo e($heading_performance_info->fequencey_data); ?></div>
                                    <span><b>তারিখ: </b> <?php echo e((!empty($heading_performance_info->performance_date))?
            ...
            ?$all_info->id:''); ?>">
                                ...
                                <td>
                                      <?php echo e((!empty($all_info->performance_odvision_info) &&
                ...
                $all_info->performance_odvision_info==3 )?"উল্লেখ নেই":""); ?>
                                ...
                                <td>
                                        ...
                                        <?php echo e((!empty($all_info->performance_ctg) &&
                ...
                $all_info->performance_ctg==2 )?"না":""); ?>
                                ...
                                <td>
           <?php echo e((!empty($all_info->performance_comments) )?$all_info->performance_comments:""); ?>

                                </td>
                                <td>
           <?php echo e((!empty($heading_performance_info->performance_created_by) )?$heading_performance_info->performance_created_by:""); ?>
