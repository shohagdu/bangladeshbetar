                    ...
                    <div class="col-sm-12" >
                        ...
                        <table style="width:100%;border:1px solid #d0d0d0" rules="all"  class="table table-bordered"
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e($songit_info->first_line); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e($songit_info->participant); ?>

                                </td>

                                <td class="text-bold">রেটিং</td>
                                <td>
                                    <?php echo e($songit_info->rating); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e($songit_info->recording_date); ?>
                                ...
                                <td>
                                    <?php echo e($songit_info->first_broadcast_date); ?>
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    <?php echo e($songit_info->hyperlink); ?>
