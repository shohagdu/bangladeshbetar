    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
                ...
                <a href="<?php echo e(url('get_program_list')); ?>" class="btn btn-primary btn-xs"
                   style="float:right;
            ...
            <div>
                <div class="widget-body no-padding">
                    <div class="col-sm-12">
                        ...
                        <?php echo Form::open(['url' => '', 'method' => 'post','id' => 'program_create_form',
                        ...
                        <div>
                            <div class="col-sm-12" style="margin-top:10px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" required placeholder="অনুষ্ঠানের নাম" name="onustha_name" class="form-control"/>
                                    </div>

                                    <label class="col-md-2 control-label"> অনুষ্ঠানের প্রকার
                                    </label>
                                    <div class="col-md-4">
                                        <select id="program_prokar" required onchange="get_song_sub_type(this.value)" class="form-control" name="program_prokar">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-md-2 control-label"> অনুষ্ঠানের অডিও ফাইল <span class="mandatory_field">*</span>
                                    </label>
                                    <div class="col-md-3">
                                    ...
                                    <label class="col-md-2 control-label"> উৎসব ও বার্ষিকী অনুষ্ঠান <span class="mandatory_field">*</span>
                                    </label>
                                    <div class="col-md-4">
                                        <select class="form-control" required id="jatio_dibos" name="jatio_dibos">
                                            <option value="">বাছাই করুন</option>
                                            <?php $__currentLoopData = $fixed_program_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label"> অনুষ্ঠানের ধরন
                                    </label>
                                    <div class="col-md-4">
                                    ...
                                    <label class="col-md-2 control-label"> অনুষ্ঠানের ভিত্তিক
                                    </label>
                                    <div class="col-md-4">
                                        <select id="program_vhittik" class="form-control" name="program_vhittik">
                                            <option value="">বাছাই করুণ</option>
                                            <option value="1">শিশু</option>
                                            <option value="2">কিশোর</option>
                                            <option value="3">যুবক-যুবতি</option>
                                            <option value="4">নারী</option>
                                            <option value="5">পুরুষ</option>
                                            <option value="6">প্রবীণ</option>
                                        </select>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-md-2 control-label"> অনুষ্ঠানের বিষয়বস্তু <span class="mandatory_field">*</span>
                                    </label>
                                    <div class="col-md-10">
                                      <textarea class="form-control" rows="6" name="onusthan_subject" placeholder="অনুষ্ঠানের বিষয়বস্তু"></textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" readonly class="form-control" placeholder="গবেষণা" />
                                                </td>
                                                <td>
                                                    <select id="artist" placeholder="gobeshona" searchid="469" class="select2-ajax" multiple name="gobeshona[]" style="width:100%; !important">
                                                ...
                                                <td>
                                                    <select id="main_artist" placeholder="গ্রন্থনা" searchid="469" class="select2-ajax" multiple name="gronthona[]" style="width:100%; !important">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select id="gitikar" placeholder="উপস্থাপনা" searchid="460" class="select2-ajax" multiple name="uposthapona[]" style="width:100%; !important">
