...
//                    dd($archive_info);
                    ...
                    <div class="col-sm-12" >
                        ...
                        <table style="width:100%;border:1px solid #d0d0d0" rules="all"  class="table table-bordered"
                            ...
                            <tr>
                                <td class="text-bold">উৎসব ও বার্ষিকী অনুষ্ঠান</td>
                                <td>
                                </td>
                                <td class="text-bold">
                                    অনুষ্ঠানের ধরন
                            ...
                            <tr>
                                <td class="text-bold">অনুষ্ঠানের বিষয়</td>
                                <td colspan="5">
                                    <?php echo e($item_info->subject); ?>

                                </td>
                                <td class="text-bold">অনুষ্ঠানের ভিত্তিক</td>
                                <td>
                                    <?php echo e(!empty($item_info->program_vhittik)?program_vittik_name($item_info->program_vhittik) : 'N/A'); ?>
                            ...
                            <tr>
                                <td class="text-bold">গবেষণা</td>
                                <td>
                                    <?php echo e(!empty($item_info->gobeshona)  ? get_shilpi_name_by_ids($item_info->gobeshona) : ''); ?>
                                ...
                                <td colspan="3">
                                    <?php echo e(!empty($item_info->gronthona)  ? get_shilpi_name_by_ids($item_info->gronthona) : ''); ?>

                                </td>
                                <td class="text-bold">উপস্থাপনা</td>
                                <td>
                                    <?php echo e(!empty($item_info->uposthapona)  ? get_shilpi_name_by_ids($item_info->uposthapona) : ''); ?>
