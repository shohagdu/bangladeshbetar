<?php echo Form::open(['url' => '/save_employee_promotion', 'method' => 'post', 'id' => 'employee_promotion_form','class'=>'form-horizontal']); ?>
...
<div class="modal-body">
    <div class="col-sm-12">
        <table class="table table-bordered width100per">
            ...
            <tr>
                <td>
                    <select name="promotion_designation[]" id="promotion_designation_<?php echo e($i); ?>" class="form-control">
                        ...
                        <?php if(!empty($designation_info)): ?>
                            <?php $__currentLoopData = $designation_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php echo e((!empty($promotion['promotion_designation']) && $promotion['promotion_designation']==$key)?"selected":''); ?> ><?php echo e($value); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                    </select>
                </td>
                <td><input type="text" value="<?php echo e((!empty($promotion['increment_date']))?$promotion['increment_date']:''); ?>" name="increment_date[]" placeholder="Increment Date" class="form-control datepickerinfo" id="increment_date_<?php echo e($i); ?>"></td>
                <td><input type="text" value="<?php echo e((!empty($promotion['go_date']))?$promotion['go_date']:''); ?>" name="go_date[]" placeholder="Go Date" class="form-control datepickerinfo" id="go_date_<?php echo e($i); ?>"></td>
                <td><input type="text" value="<?php echo e((!empty($promotion['nature_increment']))?$promotion['nature_increment']:''); ?>"  name="nature_increment[]" placeholder="Nature of Increment" class="form-control" id="nature_increment_<?php echo e($i); ?>"></td>
                <td><input type="text" name="pay_scale[]" value="<?php echo e((!empty($promotion['pay_scale']))?$promotion['pay_scale']:''); ?>" placeholder="Pay Scale" class="form-control" id="pay_scale_<?php echo e($i); ?>"></td>
