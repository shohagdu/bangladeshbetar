                        ...
                        <tr>
                            <td style="width:100%;border: 1px solid #fff !important;">
                                <table class="table table-bordered" style="width: 100%">
                                    ...
                                    ?>
                                    <tr>
                                        <td style="font-size:14px;font-weight: bold" colspan="<?php echo e((!empty($odivision_key) &&
                                        $odivision_key==1)
                                        ?1:7); ?>">
                                            <?php echo e(!empty($odivision_key)? $odivision_data[$odivision_key]:''); ?>
                                                                 ...
                                                                 foreach($array_date_info as $title=> $artist_info){
                                                                        if($title==$role_title_info){
                                                                            foreach ($artist_info as $artist_data){
                                                                               $artist_date[$artist_data['name_bn']][]=  date('d',strtotime($date_info));
                                                                            }
