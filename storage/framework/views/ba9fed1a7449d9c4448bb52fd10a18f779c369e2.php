            ...
            <div>
                <div class="widget-body no-padding">
                    <div class="col-sm-12" style="margin-top: 10px;">
                        <?php echo Form::open(['url' => '', 'method' => 'post','id' => 'show_artist_info_form',
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                ...
                                <select  name="expertise" id="expertise_1" class="form-control artist_expertise">
                                    <option value=""> চিহ্নিত করুন</option>
                                    <?php if(!empty($artist_exp_type)): ?>
                                        <?php $__currentLoopData = $artist_exp_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>"><?php echo e($value); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                </select>
