    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document" style="width:70%;">
            <div class="modal-content">
                ...
                <?php echo Form::open(['url' => '/save_land_info', 'method' => 'post', 'id' => 'stock_info_form','class'=>'form-horizontal']); ?>
                ...
                <div class="modal-body">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" id="purchase_date" class="form-control datepickerinfo" placeholder="Purchase Date" value="<?php echo e(date('d-m-Y')); ?>"  name="purchase_date"/>
                            </div>
    ...
    <div class="modal fade" id="stockOutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <?php echo Form::open(['url' => '/stock_out_info', 'method' => 'post', 'id' => 'stock_out_info','class'=>'form-horizontal']); ?>
