                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select id="station_id" required class="form-control" onchange="getSubStation(this.value)" name="station_id">
                                ...
                                <option <?php echo e($key===$schedule_info->station_id ? "selected" : ''); ?> value="<?php echo e($key); ?>"><?php echo e($value); ?></option>
                            ...
                            <tr id="<?php echo $key; ?>">
                                <td>
                                    <select style='width:150px;' placeholder="Day" id='days<?php //echo $key ?>' multiple  onchange='addData(<?php //echo $key; ?>)' class='select2'>
                                        ...
                                        <option <?php echo (!empty($value['days']) && in_array(1,$value['days'])) ? 'selected' : false; ?> value="1">শনিবার</option>
                                        <option <?php echo (!empty($value['days']) && in_array(2,$value['days'])) ? 'selected' : false; ?>  value="2">রবিবার</option>
                                        <option <?php echo (!empty($value['days']) && in_array(3,$value['days'])) ? 'selected' : false; ?>  value="3">সোমবার</option>
                                        <option <?php echo (!empty($value['days']) && in_array(4,$value['days'])) ? 'selected' : false; ?>  value="4">মঙ্গলবার</option>
                                        <option <?php echo (!empty($value['days']) && in_array(5,$value['days'])) ? 'selected' : false; ?>  value="5">বুধবার</option>
                                        <option <?php echo (!empty($value['days']) && in_array(6,$value['days'])) ? 'selected' : false; ?>  value="6">বৃহস্পতিবার</option>
                                        <option <?php echo (!empty($value['days']) && in_array(7,$value['days'])) ? 'selected' : false; ?>  value="7">শুক্রবার</option>
                                        <option <?php echo (!empty($value['days']) && in_array(8,$value['days'])) ? 'selected' : false; ?>  value="8">প্রতিদিন</option>
                                 ...
                                 <td>
                                    <select class='form-control' id='projejeno<?php echo $key ?>' onchange='addData(<?php echo $key; ?>)' >
                                        ...
                                        <?php if(!empty($employee_info)): ?>
                                            <?php $__currentLoopData = $employee_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp_key=> $emp_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo  (!empty($value['projejeno']) &&
                                                    $value['projejeno']==$emp_key )?"selected":'';
                                                        ?> value="<?php echo e($emp_key); ?>"><?php echo e($emp_value); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </select>
                                </td>
                                <td>
                                    <select class='form-control' id='tottabodane<?php echo $key ?>' onchange='addData(<?php echo $key; ?>)'>
                                        <option value=''>চিহ্নিত করুন</option>
                                        <?php if(!empty($employee_info)): ?>
                                            <?php $__currentLoopData = $employee_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $totabodane_key=> $emp_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo  (!empty($value['tottabodane']) &&
                                                    $value['tottabodane']==$totabodane_key )?"selected":'';
                                                ?> value="<?php echo e($totabodane_key); ?>"><?php echo e($emp_value); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </select>
                                </td>
