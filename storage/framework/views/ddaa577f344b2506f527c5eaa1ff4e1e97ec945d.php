                    ...
                    <div class="col-sm-12" >
                        ...
                        <table style="width:100%;border:1px solid #d0d0d0" rules="all"  class="table table-bordered"
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e($item_info->program_name); ?>
                                ...
                                <td>
                                    <?php echo e($item_info->grohoner_date); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo e($item_info->sakhhat_data); ?>
                                ...
                                <td>
                                    <?php echo e($item_info->work_area); ?>

                                </td>

                                <td class="text-bold">স্থান</td>
                                <td colspan="3">
                                    <?php echo e(!empty($item_info->place)?$item_info->place:'N/A'); ?>
                            ...
                            ?>
                            <tr>
                                <td><?php echo e(get_archive_type_name($type)); ?></td>
                                <td colspan="7">
                                    <?php echo e(get_file_name($array)); ?>
                            ...
                            ?>
                            <tr>
                                <td><?php echo e(get_vumika_name($type)); ?></td>
                                <td colspan="7">
                                    <?php echo e(get_shilpi_name_by_ids($array)); ?>
                            ...
                            <tr>
                                ...
                                <td colspan="7">
                                    <?php echo e(get_sakhhatkar_department_name($item_info->sakhhatkar_department)); ?>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <?php echo e(!empty($item_info->sakhhatkar_vhittik->sakhhatkardata) ? get_shilpi_name_by_ids($item_info->sakhhatkar_vhittik->sakhhatkardata) : ''); ?>

                                </td>
                                <td>সাক্ষাৎকার গ্রহীতা</td>
                                <td colspan="3">
                                    <?php echo e(!empty($item_info->sakhhatkar_vhittik->sakhhatkar_grohita) ? get_shilpi_name_by_ids($item_info->sakhhatkar_vhittik->sakhhatkar_grohita) : ''); ?>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <?php echo e(!empty($item_info->alochona_onusthan->sonchalok) ? get_shilpi_name_by_ids($item_info->alochona_onusthan->sonchalok) : ''); ?>

                                </td>
                                <td>আলোচনা অংশগ্রহণকারী</td>
                                <td colspan="3">
                                    <?php echo e(!empty($item_info->alochona_onusthan->ongshogrohonkari) ? get_shilpi_name_by_ids($item_info->alochona_onusthan->ongshogrohonkari) : ''); ?>
                            ...
                            <tr>
                                <td>গ্রন্থনা</td>
                                <td colspan="3">
                                    <?php echo e(!empty($item_info->sms->gronthona) ? get_shilpi_name_by_ids($item_info->sms->gronthona) : ''); ?>

                                </td>
                                <td>উপস্থাপনা</td>
                                <td colspan="3">
                                    <?php echo e(!empty($item_info->sms->uposthapona) ? get_shilpi_name_by_ids($item_info->sms->uposthapona) : ''); ?>
                            ...
                            <tr>
                                <td>বিশেষজ্ঞ</td>
                                <td colspan="3">
                                    <?php echo e(!empty($item_info->phone_in_program->bishesoggo) ? get_shilpi_name_by_ids($item_info->phone_in_program->bishesoggo) : ''); ?>

                                </td>
                                <td>পরিচালনা</td>
                                <td colspan="3">
                                    <?php echo e(!empty($item_info->phone_in_program->porichalona) ? get_shilpi_name_by_ids($item_info->phone_in_program->porichalona) : ''); ?>
                            ...
                            <tr>
                                <td>প্রতিবেদক</td>
                                <td colspan="7">
                                    <?php echo e(!empty($item_info->protibedon->protibedok) ? get_shilpi_name_by_ids($item_info->protibedon->protibedok) : ''); ?>
                            ...
                            <tr>
                                <td>বিতরক পর্যায়</td>
                                <td>
                                    <?php echo e(!empty($item_info->bitorko->bitorko_porjay) ? get_bitorko_projay_name($item_info->bitorko->bitorko_porjay) : ''); ?>

                                </td>
                                <td>বিতরক বিচারক</td>
                                <td>
                                    <?php echo e(!empty($item_info->bitorko->bitorko_bicharok) ? get_shilpi_name_by_ids($item_info->bitorko->bitorko_bicharok) : ''); ?>

                                </td>
                                <td>বিতর্ক পরিচালনা</td>
                                <td>
                                    <?php echo e(!empty($item_info->bitorko->bitorko_porichalona) ? get_shilpi_name_by_ids($item_info->bitorko->bitorko_porichalona) : ''); ?>

                                </td>
                                <td>বিতর্ক সহযোগিতা</td>
                                <td>
                                    <?php echo e(!empty($item_info->bitorko->bitorko_shohojogita) ? get_shilpi_name_by_ids($item_info->bitorko->bitorko_shohojogita) : ''); ?>
