    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <a href="<?php echo e(url('contract_khata')); ?>" class="btn btn-info btn-xs"
                   style="float:right;
                                ...
                                <?php $__currentLoopData = $get_program_planning_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $singleData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button title="Move to Proposal" type="button" onclick="planningAgain('<?php echo e($singleData->id); ?>','2')" class="btn btn-danger btn-xs">
                                                <i class="glyphicon glyphicon-backward"></i> Proposal
                                            </button>


                                            <button title="Studio Booking / Gate Pass / Recording" type="button"
                                                    onclick="approvedProposalInfo('<?php echo e($singleData->id); ?>','4')"
