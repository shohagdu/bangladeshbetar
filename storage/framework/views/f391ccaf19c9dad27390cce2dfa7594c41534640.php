    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <?php if(!empty($program_plan->studio_infos)): ?>
                <a  href="<?php echo e(url('studio_information_view/'.$program_plan->id)); ?>"title="Studio Information"   class="btn btn-primary btn-xs"
                        ...
                        <form id="update_program_planning_form">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>স্টুডিও  আইডি</td>
                                    <td>
                                       <input type="text" name="studio_id" value="<?php echo e($program_plan->studio_id); ?>" placeholder="স্টুডিও  আইডি"
                                              class="form-control">
                                    </td>
                                </tr>
...
//                                 print_r($studio_infos);exit;
                                ...
                                <tr>
                                    <td>
                                        <input type="text" readonly class="form-control" value="<?php echo e($title); ?>"/>
                                    ...
                                    <td>
                                        <select  id="magazine_manage_<?php echo e($key); ?>" placeholder="<?php echo e($title); ?>"  class="select2"
                                                                multiple required
                                            ...
                                            <?php if(!empty($employee_info)): ?>
                                                <?php $__currentLoopData = $employee_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ekey => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php echo e(is_array($studio_infos) && isset($studio_infos[$key]) &&  in_array($ekey,$studio_infos[$key]) ? 'selected' : ''); ?> value="<?php echo e($ekey); ?>"><?php echo e($value); ?></option>
                                ...
                                <tr>
                                    ...
                                    <input type="hidden" value="<?php echo e($setting_id); ?>" name="setting_id" id="setting_id">
                                    </td>
                                </tr>
