    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <a href="<?php echo e(url('program_recording_list')); ?>" class="btn btn-info btn-xs"
                   style="float:right;
                margin-top:5px;margin-right:5px;"><i class="glyphicon glyphicon-list"></i>
                    রেকডিং লিস্ট
                </a>
                <a href="<?php echo e(url('recording_performance_khata')); ?>" class="btn btn-primary btn-xs"
                   style="float:right;
            ...
            <div>
                <div class="widget-body no-padding">
                    <div class="col-sm-12">
                        ...
                        <?php echo Form::open(['url' => '', 'method' => 'post','id' => 'searchRecordingPerformanceInfoFrom',
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <button type="button" class="btn btn-success btn-sm"
                                        onclick="searchRecordingPerformanceInfo()"
