...
'class'=>'form-horizontal']); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            ...
            <a href="<?php echo e(url('archive_book?archive_type=2')); ?>">
...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        foreach($item_type as $key_id) {
            ...
            ?>
        <span class="badge">
                                                <?php echo e(get_kobita_key_text($key_id)); ?>

            <?php
            foreach(array_unique($_REQUEST[get_kobita_key_name($key_id)]) as $index  =>  $value) {
            echo $value;
            ?>
                                                <a href="<?php echo e(get_request_url(get_kobita_key_name($key_id),$index)); ?>">
                                                    <i style="color:darkred" class="fa fa-close"></i>
                                                </a>
                                                <?php
            }
                ...
                if(!empty($archive_list)) {
                    foreach($archive_list as $row) {
                     ...
                     <tr>
                         ...
                         <td>
                             <?php echo e(!empty($item_info->golpo_pathok)  ? get_shilpi_name_by_ids($item_info->golpo_pathok) : ''); ?>
