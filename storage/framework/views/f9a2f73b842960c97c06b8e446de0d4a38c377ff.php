...
<?php $__env->startSection('title_area'); ?>
    ::  শিল্পী সম্মানীর প্রধান  ক্যাটাগরি  ::
    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <h2> শিল্পী সম্মানীর প্রধান  ক্যাটাগরি</h2>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-sm-8">
                        <h5 class="modal-title" id="exampleModalLabel">অনুষ্ঠানের প্রকৃতি </h5>
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="hidden" value="15" name="type" id="type">
                        <input type="hidden" value="program_style_setup" name="redirect_page" id="redirect_page">
